...
To generate the necessary credentials, you must have a registered account on dataspace.copernicus.eu. If you don’t have an account, you can register by following the [User registration and authentication](https://documentation.dataspace.copernicus.eu/Registration.html) page.

## Generate secrets

In order to obtain secrets, [visit page](https://eodata-s3keysmanager.dataspace.copernicus.eu/) and log in with the Copernicus Data Space Ecosystem account for which the keys are to be generated. After successfully logging in, indicate the expiration date of the secrets using the “Add Credentials” button and click “Confirm”.
