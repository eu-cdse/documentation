...
``` python
url = "https://sh.dataspace.copernicus.eu/batch/v2/process"
...
``` python
url = f"https://sh.dataspace.copernicus.eu/batch/v2/process/{batch_request_id}"
...
``` python
url = f"https://sh.dataspace.copernicus.eu/batch/v2/process/{batch_request_id}/analyse"
...
``` python
url = f"https://sh.dataspace.copernicus.eu/batch/v2/process/{batch_request_id}/start"
...
``` python
url = f"https://sh.dataspace.copernicus.eu/batch/v2/process/{batch_request_id}/stop"
