...
Tokens are JSON Web Tokens (JWT), more information about them [here](https://en.wikipedia.org/wiki/JSON_Web_Token) or [here](https://datatracker.ietf.org/doc/html/rfc7519).
