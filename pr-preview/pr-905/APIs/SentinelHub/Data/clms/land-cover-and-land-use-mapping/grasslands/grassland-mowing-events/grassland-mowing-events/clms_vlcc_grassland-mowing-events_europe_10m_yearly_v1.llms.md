...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-480a24cb-713c-4e72-bcf9-a4edba3f4341` for the BYOC collection with id `480a24cb-713c-4e72-bcf9-a4edba3f4341`.
...
| Collection | ID |
|:--:|----|
| Grassland Mowing Events | `480a24cb-713c-4e72-bcf9-a4edba3f4341` |
| Grassland Mowing Events Confidence Layer | `0967983d-9a66-4e4d-93f9-fb91a1a1215e` |
