...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-74eeaebb-d8eb-4e7e-909c-ab55465a8791` for the BYOC collection with id `74eeaebb-d8eb-4e7e-909c-ab55465a8791`.
