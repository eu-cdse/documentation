...
[View this dataset in Copernicus Browser](https://browser.dataspace.copernicus.eu/?zoom=10&lat=41.82019&lng=12.57866&themeId=DEFAULT-THEME&datasetId=COPERNICUS_CLMS_VLCC_BROADLEAVED-COVER-DENSITY_EUROPE_100M_YEARLY_V1&clmsSelectedPath=Broadleaved%20Cover%20Density&clmsSelectedCollection=COPERNICUS_CLMS_VLCC_BROADLEAVED-COVER-DENSITY_EUROPE_100M_YEARLY_V1) (Click on ‘Show latest date’ after the page loads.)
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-a06a42ae-f899-4a07-a5cd-fb7fd920d6c1` for the BYOC collection with id `a06a42ae-f899-4a07-a5cd-fb7fd920d6c1`.
...
**[Example scripts for this product.](https://github.com/eu-cdse/sentinel-hub-custom-scripts/tree/main/clms/land-cover-and-land-use-mapping/tree-cover-and-forests/dominant-leaf-type/broadleaved-cover-density/clms_vlcc_broadleaved-cover-density_europe_100m_yearly_v1)**
