...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-deada876-a483-4b45-baf2-85086860ab8b` for the BYOC collection with id `deada876-a483-4b45-baf2-85086860ab8b`.
