# LWQ 2024-present (raster 300 m), global, 10-daily – version 2
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-5c2c9b2c-2893-41d9-b2bc-fbd6e5b8b31d` for the BYOC collection with id `5c2c9b2c-2893-41d9-b2bc-fbd6e5b8b31d`.
