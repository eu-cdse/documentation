...
[Official documentation](https://land.copernicus.eu/en/products/water-bodies/lake-ice-extent-baltic-v1-250m)

Classifies, in pixels, inland/freshwater bodies

[View this dataset in Copernicus Browser](https://browser.dataspace.copernicus.eu/?zoom=10&lat=41.82019&lng=12.57866&themeId=DEFAULT-THEME&datasetId=COPERNICUS_CLMS_LIE_BALTIC_250M_DAILY_V1&clmsSelectedPath=River%20and%20Lake%20Ice%20Extent&clmsSelectedCollection=COPERNICUS_CLMS_LIE_BALTIC_250M_DAILY_V1) (Click on ‘Show latest date’ after the page loads.)
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-bfebf889-ca5c-4baa-abbc-04907f1e8de8` for the BYOC collection with id `bfebf889-ca5c-4baa-abbc-04907f1e8de8`.
...
`bfebf889-ca5c-4baa-abbc-04907f1e8de8`
...
**[Example scripts for this product.](https://github.com/eu-cdse/sentinel-hub-custom-scripts/tree/main/clms/bio-geophysical-parameters/water-bodies/river-and-lake-ice-extent/lie_baltic_250m_daily_v1)**
