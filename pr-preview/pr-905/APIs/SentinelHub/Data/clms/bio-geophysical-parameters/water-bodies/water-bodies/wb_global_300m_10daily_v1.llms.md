...
[Official documentation](https://land.copernicus.eu/en/products/water-bodies/water-bodies-global-v1-0-300m)

Detects the areas covered by inland water.

[View this dataset in Copernicus Browser](https://browser.dataspace.copernicus.eu/?zoom=10&lat=41.82019&lng=12.57866&themeId=DEFAULT-THEME&datasetId=COPERNICUS_CLMS_WB_300M_10DAILY_V1&clmsSelectedPath=Water%20Bodies&clmsSelectedCollection=COPERNICUS_CLMS_WB_300M_10DAILY_V1) (Click on ‘Show latest date’ after the page loads.)
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-caae3fa1-7166-432b-8d9e-322ade546ade` for the BYOC collection with id `caae3fa1-7166-432b-8d9e-322ade546ade`.
...
`caae3fa1-7166-432b-8d9e-322ade546ade`
...
**[Example scripts for this product.](https://github.com/eu-cdse/sentinel-hub-custom-scripts/tree/main/clms/bio-geophysical-parameters/water-bodies/water-bodies/wb_global_300m_10daily_v1)**
