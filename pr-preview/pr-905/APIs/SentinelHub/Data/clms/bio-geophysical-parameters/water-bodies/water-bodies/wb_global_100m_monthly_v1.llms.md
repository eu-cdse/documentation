# Water Bodies 2020-present (raster 100 m), global, monthly – version 1
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-69577a6b-80e0-4507-8b99-57b5ef167d41` for the BYOC collection with id `69577a6b-80e0-4507-8b99-57b5ef167d41`.
