# LIE 2024-present (raster 250 m), Europe, daily – version 2
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-bf10847c-b070-4205-936c-bc827d958302` for the BYOC collection with id `bf10847c-b070-4205-936c-bc827d958302`.
