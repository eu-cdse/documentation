# Water Bodies (raster 1km), global, 10-daily – version 2
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-ba17bfe3-e702-47c6-b528-cf99256fbc30` for the BYOC collection with id `ba17bfe3-e702-47c6-b528-cf99256fbc30`.
