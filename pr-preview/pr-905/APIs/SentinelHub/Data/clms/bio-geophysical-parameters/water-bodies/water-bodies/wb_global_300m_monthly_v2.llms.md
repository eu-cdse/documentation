# Water Bodies 2020-present (raster 300 m), global, monthly – version 2
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-c19a3068-8be5-4077-8233-1dc54fbffe31` for the BYOC collection with id `c19a3068-8be5-4077-8233-1dc54fbffe31`.
