# LST (TCI) 2017-2021 (raster 5 km), global, 10-daily – version 1
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-2dd2d9e0-8f02-4adc-8b14-dea6c56e8d2b` for the BYOC collection with id `2dd2d9e0-8f02-4adc-8b14-dea6c56e8d2b`.
