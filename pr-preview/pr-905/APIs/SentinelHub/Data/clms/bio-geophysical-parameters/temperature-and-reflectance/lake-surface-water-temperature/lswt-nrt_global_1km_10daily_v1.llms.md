# Lake Surface Water Temperature 2016-present (raster 1 km), global, 10-daily, Near Real Time – version 1
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-401ca642-a169-4783-b1cf-cbd33e98eccb` for the BYOC collection with id `401ca642-a169-4783-b1cf-cbd33e98eccb`.
