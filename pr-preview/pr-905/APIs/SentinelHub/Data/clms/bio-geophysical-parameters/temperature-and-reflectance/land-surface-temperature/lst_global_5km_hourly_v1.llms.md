# LST 2010-2021 (raster 5 km), global, hourly – version 1
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-2950f0fb-22ab-4ed7-98f9-a90ac841092b` for the BYOC collection with id `2950f0fb-22ab-4ed7-98f9-a90ac841092b`.
