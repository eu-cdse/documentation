# LST (TCI) 2021-present (raster 5 km), global, 10-daily – version 2
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-d216f9f3-a7bd-45d6-bdd3-820f8223ebc4` for the BYOC collection with id `d216f9f3-a7bd-45d6-bdd3-820f8223ebc4`.
