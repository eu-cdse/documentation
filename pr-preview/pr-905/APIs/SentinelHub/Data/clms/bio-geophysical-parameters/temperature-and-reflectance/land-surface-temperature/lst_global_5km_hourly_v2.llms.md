# LST 2021-present (raster 5 km), global, hourly – version 2
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-41dad7d0-e730-45fe-a974-a9c718fd08af` for the BYOC collection with id `41dad7d0-e730-45fe-a974-a9c718fd08af`.
...
`41dad7d0-e730-45fe-a974-a9c718fd08af`
...
**[Example scripts for this product.](https://github.com/eu-cdse/sentinel-hub-custom-scripts/tree/main/clms/bio-geophysical-parameters/temperature-and-reflectance/land-surface-temperature/lst_global_5km_hourly_v2)**
