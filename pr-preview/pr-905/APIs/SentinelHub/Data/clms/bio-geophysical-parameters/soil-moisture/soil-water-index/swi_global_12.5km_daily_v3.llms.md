# SWI 2007-present (raster 12.5 km), global, daily – version 3
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-f2278442-eb7f-4926-93e9-7a382f567fb4` for the BYOC collection with id `f2278442-eb7f-4926-93e9-7a382f567fb4`.
