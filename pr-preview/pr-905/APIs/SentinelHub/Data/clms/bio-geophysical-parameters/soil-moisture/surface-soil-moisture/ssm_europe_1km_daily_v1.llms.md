# SSM 2014-present (raster 1 km), Europe, daily – version 1
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-df9e9783-f580-433a-b798-3acd2760b94e` for the BYOC collection with id `df9e9783-f580-433a-b798-3acd2760b94e`.
