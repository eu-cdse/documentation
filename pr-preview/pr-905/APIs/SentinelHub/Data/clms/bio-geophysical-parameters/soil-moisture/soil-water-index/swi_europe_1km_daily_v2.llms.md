# SWI 2015-present (raster 1 km), Europe, daily – version 2
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-4bd995a1-dc49-4176-a285-b1d0084ba51a` for the BYOC collection with id `4bd995a1-dc49-4176-a285-b1d0084ba51a`.
