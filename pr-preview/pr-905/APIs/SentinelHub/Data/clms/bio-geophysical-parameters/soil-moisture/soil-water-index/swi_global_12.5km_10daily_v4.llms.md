# SWI 2007-present (raster 12.5 km), global, 10-daily – version 4
...
[View this dataset in Copernicus Browser](https://browser.dataspace.copernicus.eu/?zoom=10&lat=41.82019&lng=12.57866&themeId=DEFAULT-THEME&datasetId=COPERNICUS_CLMS_SWI_12_5KM_10DAILY_V4&clmsSelectedPath=Soil%20Water%20Index&clmsSelectedCollection=COPERNICUS_CLMS_SWI_12_5KM_10DAILY_V4) (Click on ‘Show latest date’ after the page loads.)
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-d0413fe0-46dc-4c2c-96a2-437e726d89a3` for the BYOC collection with id `d0413fe0-46dc-4c2c-96a2-437e726d89a3`.
...
`d0413fe0-46dc-4c2c-96a2-437e726d89a3`
...
| VOBS001 | Percentage of valid observations in the 10-day synthesis period. | % | UINT8 | 0.0-100.0 | 1 | 0 |
| VOBS005 | Percentage of valid observations in the 10-day synthesis period. | % | UINT8 | 0.0-100.0 | 1 | 0 |
| VOBS010 | Percentage of valid observations in the 10-day synthesis period. | % | UINT8 | 0.0-100.0 | 1 | 0 |
| VOBS015 | Percentage of valid observations in the 10-day synthesis period. | % | UINT8 | 0.0-100.0 | 1 | 0 |
| VOBS020 | Percentage of valid observations in the 10-day synthesis period. | % | UINT8 | 0.0-100.0 | 1 | 0 |
| VOBS040 | Percentage of valid observations in the 10-day synthesis period. | % | UINT8 | 0.0-100.0 | 1 | 0 |
| VOBS060 | Percentage of valid observations in the 10-day synthesis period. | % | UINT8 | 0.0-100.0 | 1 | 0 |
| VOBS100 | Percentage of valid observations in the 10-day synthesis period. | % | UINT8 | 0.0-100.0 | 1 | 0 |

## Evalscript

**[Example scripts for this product.](https://github.com/eu-cdse/sentinel-hub-custom-scripts/tree/main/clms/bio-geophysical-parameters/soil-moisture/soil-water-index/swi_global_12.5km_10daily_v4)**
