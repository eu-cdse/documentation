# SWI 2007-present (raster 12.5 km), global, daily – version 4
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-59c08cd0-762b-4b8a-9eaa-0d55d054a732` for the BYOC collection with id `59c08cd0-762b-4b8a-9eaa-0d55d054a732`.
