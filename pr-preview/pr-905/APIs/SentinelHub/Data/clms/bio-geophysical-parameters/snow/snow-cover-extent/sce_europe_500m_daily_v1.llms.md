# SCE 2017-present (raster 500 m), Europe, daily – version 1
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-4b3fe9bb-77d8-4699-b50c-02136939ed0c` for the BYOC collection with id `4b3fe9bb-77d8-4699-b50c-02136939ed0c`.
