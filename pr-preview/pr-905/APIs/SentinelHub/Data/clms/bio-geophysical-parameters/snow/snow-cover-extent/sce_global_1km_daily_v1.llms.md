# SCE 2025-present (raster 1km), global, daily – version 1
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-84c1669b-a51f-4193-bf9d-e470e46efea8` for the BYOC collection with id `84c1669b-a51f-4193-bf9d-e470e46efea8`.
