# SWE 2006-2024 (raster 5 km), Northern Hemisphere, daily – version 1
...
[View this dataset in Copernicus Browser](https://browser.dataspace.copernicus.eu/?zoom=10&lat=41.82019&lng=12.57866&themeId=DEFAULT-THEME&datasetId=COPERNICUS_CLMS_SWE_5KM_DAILY_V1&clmsSelectedPath=Snow%20Water%20Equivalent&clmsSelectedCollection=COPERNICUS_CLMS_SWE_5KM_DAILY_V1) (Click on ‘Show latest date’ after the page loads.)
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-662b538b-8de9-43dc-85fd-3859b42f7482` for the BYOC collection with id `662b538b-8de9-43dc-85fd-3859b42f7482`.
...
**[Example scripts for this product.](https://github.com/eu-cdse/sentinel-hub-custom-scripts/tree/main/clms/bio-geophysical-parameters/snow/snow-water-equivalent/swe_northernhemisphere_5km_daily_v1)**
