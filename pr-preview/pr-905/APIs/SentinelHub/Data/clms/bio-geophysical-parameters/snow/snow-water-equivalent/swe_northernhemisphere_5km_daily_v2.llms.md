# SWE 2024-present (raster 5 km), Northern Hemisphere, daily – version 2
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-f38bc9f2-5a14-448f-8265-b8070fe288bb` for the BYOC collection with id `f38bc9f2-5a14-448f-8265-b8070fe288bb`.
