...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-12a01750-273b-4ed0-bd8d-da317cdd802a` for the BYOC collection with id `12a01750-273b-4ed0-bd8d-da317cdd802a`.
