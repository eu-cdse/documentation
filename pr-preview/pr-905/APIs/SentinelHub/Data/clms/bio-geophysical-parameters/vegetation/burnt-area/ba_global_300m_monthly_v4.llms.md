# Burnt Area 2018 - present (raster 300 m), global, monthly - version 4
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-b8b617c6-182f-427e-a86c-23fc36ac6098` for the BYOC collection with id `b8b617c6-182f-427e-a86c-23fc36ac6098`.
