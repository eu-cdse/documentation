# GPP 2023-present (raster 300 m), global, 10-daily – version 1
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-caff03c0-88b5-4b12-8679-af4cc7352330` for the BYOC collection with id `caff03c0-88b5-4b12-8679-af4cc7352330`.
