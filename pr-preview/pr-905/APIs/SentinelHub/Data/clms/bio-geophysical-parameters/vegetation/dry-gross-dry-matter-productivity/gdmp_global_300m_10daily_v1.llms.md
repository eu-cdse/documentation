# GDMP 2014-present (raster 300 m), global, 10-daily – version 1
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-75c193c0-ba47-4b2a-85dd-f67a0193623e` for the BYOC collection with id `75c193c0-ba47-4b2a-85dd-f67a0193623e`.
