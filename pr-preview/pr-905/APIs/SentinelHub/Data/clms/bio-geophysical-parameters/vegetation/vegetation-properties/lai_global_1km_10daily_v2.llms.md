# LAI 1999-2020 (raster 1 km), global, 10-daily – version 2
...
\*Please note that the temporal resolution varies between RT versions: RT none is available from 2014-01-10 to 2020-08-31, RT0-RT2 from 2016-09-10 to present, and RT6 from 2020-07-10 to present.
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-4e9b1791-0529-4cbe-82dd-ccbd1d346f60` for the BYOC collection with id `4e9b1791-0529-4cbe-82dd-ccbd1d346f60`.
