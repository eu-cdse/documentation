# Burnt Area 2025 - present (raster 300 m), global, daily – version 4
...
For direct use of the APIs with e.g. oauthlib or cURL requests, use `byoc-<collectionId>` as the value of the `input.data.type` parameter in your API requests. For example, set it to `byoc-162ee729-86a7-45bc-9cfe-c01f718e3216` for the BYOC collection with id `162ee729-86a7-45bc-9cfe-c01f718e3216`.
...
`162ee729-86a7-45bc-9cfe-c01f718e3216`
...
**[Example scripts for this product.](https://github.com/eu-cdse/sentinel-hub-custom-scripts/tree/main/clms/bio-geophysical-parameters/vegetation/burnt-area/ba_global_300m_daily_v4)**
