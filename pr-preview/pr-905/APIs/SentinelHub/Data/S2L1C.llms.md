...
General information about Sentinel-2 mission can be found [here](../../../Data/SentinelMissions/Sentinel2.llms.md). Sentinel Hub offers [Sentinel-2 Level 1C](../../../Data/SentinelMissions/Sentinel2.llms.md#sentinel-2-level-1c-top-of-atmosphere-toa) products.

## Accessing Sentinel-2 L1C Data

To access data you need to send a POST request to our `process` API. The requested data will be returned as the response to your request. Each POST request can be tailored to get you exactly the data you require. To do this requires setting various parameters which depend on the datasource you are querying. This chapter will help you understand the parameters for S2L1C data. To see examples of such requests go [here](../../../APIs/SentinelHub/Process/Examples/S2L1C.llms.md), and for an overview of all API parameters see the [API Reference](../../../APIs/SentinelHub/ApiReference.llms.md).
...
| dataMask | The mask of data/no data pixels ([more](../../../APIs/SentinelHub/UserGuides/Datamask.llms.md)). | N/A | \[2\] |
...
[`scenes` object](../../../APIs/SentinelHub/Evalscript/Functions.llms.md#scenes) stores metadata. An example of metadata available in `scenes` object for Sentinel-2 L1C when mosaicking is `ORBIT`:
...
To access Sentinel 2 L1C product metadata you need to send search request to our [Catalog API](../../../APIs/SentinelHub/Catalog.llms.md). The requested metadata will be returned as JSON formatted response to your request. This chapter will help with understanding Sentinel 2 L1C specific parameters for search request.
...
[S2L1C examples](../../../APIs/SentinelHub/Process/Examples/S2L1C.llms.md)
