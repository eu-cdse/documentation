...
Please be aware that curl command might have a different syntax on Windows. Please refer to the curl official documentation if you have any questions ([https://curl.se/docs/manual.html](https://curl.se/docs/manual.html)).

## Direct access

Interaction with Traceability Service directly via the Traceability Service API: [https://trace.dataspace.copernicus.eu/api/v1/traces/name/S2A_MSIL1C_20230420T100021_N0509_R122_T33UVP_20230420T120027.SAFE.zip](https://trace.dataspace.copernicus.eu/api/v1/traces/name/S2A_MSIL1C_20230420T100021_N0509_R122_T33UVP_20230420T120027.SAFE.zip)
...
[https://github.com/eu-cdse/trace-cli#digital-signatures](https://github.com/eu-cdse/trace-cli#digital-signatures)
...
- Link to certificate: [https://ca.cloudferro.com/certs/ca.crt](https://ca.cloudferro.com/certs/ca.crt)  
- Link to certificate revocation list: [https://ca.cloudferro.com/certs/cdse-ca.crl](https://ca.cloudferro.com/certs/cdse-ca.crl)
