...
- **API**: Application Programming Interface ([wikipedia](https://en.wikipedia.org/wiki/Application_programming_interface)), a (standardized) communication protocol, for example between a client application and back-end service
...
User-defined processes can for example be shared in the [openEO algorithm plaza](https://marketplace-portal.dataspace.copernicus.eu/). You can find more information in [this page](https://documentation.dataspace.copernicus.eu/Applications/AlgorithmPlaza.html)
...
The abbreviation **UDF** stands for **user-defined function**. With this concept, users are able to upload custom code and have it executed e.g. for every pixel of a scene, or applied to a particular dimension or set of dimensions, allowing custom server-side calculations. See the section on [UDFs](https://open-eo.github.io/openeo-python-client/udf.html) for more information.
