...
- Services onboarded shall adhere to the Ecosystem [Code of Conduct](https://dataspace.copernicus.eu/ecosystem-code-conduct) and CDSE [Terms & Conditions](https://dataspace.copernicus.eu/terms-and-conditions)
...
Interested entities may opt for different processes to onboard their applications / services / operations in the Ecosystem, with different levels of autonomy, from an autonomous self-onboarding process to a fully supported process.  
In addition, eligible public entities benefit from a dedicated onboarding to streamline the integration of CDSE services and to facilitate the end-user access to Copernicus data and information.  
...
[How to become a registered 3rd party service?](https://dataspace.copernicus.eu/ecosystem/services/about#joinecosystem)

**Submit a request to join the ecosystem**  
Are you interested to present a service tile under the CDSE Ecosystem Services Registry?

[Submit a request to join the Ecosystem](https://dataspace.copernicus.eu/ecosystem/join)

Please take note that following **eligibility criteria** shall be met to allow publication under the CDSE Services Registry:

- The Earth Observation Service is deployed and operated fully or partially within the Ecosystem cloud environment(s) or the Service operates on an Ecosystem federated with CDSE
- The Service includes the usage of data and/or services provided through the CDSE data repository
- The Service is open to user registration
- For Services available on a commercial basis, a public price list is available and accessible to any user
- For [Registered 3rd Party Services](https://documentation.dataspace.copernicus.eu/Ecosystem/Ecosystem_Services_Categories.html#registered-3rd-party-services), provide a minimum of free-to-the-user service capacity, or a service demonstration capability
- The Service adheres to the Ecosystem [Code of Conduct](https://dataspace.copernicus.eu/ecosystem-code-conduct)

## Onboarding support for eligible public services

Public services eligible for a dedicated onboarding support are identified by the European Commission. The level of integration / federation with the Ecosystem and CDSE is defined by the service to be onboarded and the onboarding implementation plan jointly agreed between the public service, the Service Operator and ESA.  
...
[^1]: <https://helpcenter.dataspace.copernicus.eu/hc/en-gb/requests/new>
