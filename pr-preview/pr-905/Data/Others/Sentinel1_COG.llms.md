# Handling Sentinel-1 COG_SAFE products
...
2.  A suffix “\_COG” was added to the name of the product and a new CRC code was calculated. For example, the original product
    ...
    S1A_IW_GRDH_1SDV_20230206T165050_20230206T165115_047118_05A716\_**53C5**.safe became

    S1A_IW_GRDH_1SDV_20230206T165050_20230206T165115_047118_05A716\_**74F9_COG**.safe.

3.  Manifest file was adjusted so that it reflects these changes:

    1.  `safe:processing` element with a name=“COG Conversion” was added. It contains metadata about the conversion and includes the name of the original product under `safe:resource` child element.

    2.  `dataObject` elements, which describe the measurements files, have updated values for “size”, “href”, “checksum”.
