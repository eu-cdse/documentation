# Access through Research Network
...
Discover the new services on the [Copernicus Data Space Ecosystem](https://dataspace.copernicus.eu/#/) portal.

Use the [documentation](https://documentation.dataspace.copernicus.eu/Home.html) portal.

#### 2. Become a registered user

If you don’t have an account, you need to register as a new user. Follow the steps on [User registration and authentication](https://documentation.dataspace.copernicus.eu/Registration.html).

#### 3. Request a KeyCloak token

This is required to access to OData catalogue API.

To get the token you can follow the steps on [Access token](https://documentation.dataspace.copernicus.eu/APIs/Token.html).

#### 4. Use OData catalogue API to search the products

As a default configuration you can use the general URL [https://catalogue.dataspace.copernicus.eu/odata/v1/Products](https://catalogue.dataspace.copernicus.eu/odata/v1/Products).
...
**Alternatively, you can also use** [https://catalogue.ams.dataspace.copernicus.eu/odata/v1/Products](https://catalogue.ams.dataspace.copernicus.eu/odata/v1/Products).
...
To access EO data via S3, please refer to [S3 Access](https://documentation.dataspace.copernicus.eu/APIs/S3.html).
...
[https://catalogue.dataspace.copernicus.eu/odata/v1/Products](https://catalogue.dataspace.copernicus.eu/odata/v1/Products)
