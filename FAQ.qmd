...
<details id="what-to-do-if-run-out-of-quota">
    <summary onclick="handleQuestionClick('what-to-do-if-run-out-of-quota')">What can I do if I run out of download quota, processing units, or requests?</summary>
    Every user account is set with a limited quota to guarantee fair sharing of free tier resources within all users of the Copernicus Data Space Ecosystem (CDSE).<br><br>
    The total volume of downloads from the CDSE for each user account is summed up for the last 30 days. The downloaded volume is checked on an hourly basis, and if it exceeds the assigned quota, the user will be moved to a slower interface. Such users will still be able to access and download products but at a reduced speed. More information about the quotas and limitations is also available in <a href="https://documentation.dataspace.copernicus.eu/Quotas.html">Quotas and Limitations</a>. <br>
    If you run out of download quota or requests, you can consider the following options: 
        <ul>
            <li>You can make use of the commercial provider integrated with CDSE, see <a href="https://dataspace.copernicus.eu/ecosystem/services/creodias">CREODIAS</a> and directly contact them. </li>
            <li>See <a href="https://documentation.dataspace.copernicus.eu/FAQ.html#which-users-are-eligible-for-which-account-types">Which users are eligible for which account types (Quotas)</a> and <a href="https://documentation.dataspace.copernicus.eu/FAQ.html#which-entities-are-qualified-to-get-higher-quotas-in-scope-of-copernicus-services-group-and-how-can-one-ask-for-it">Which entities are qualified to get higher quotas in scope of “Copernicus Services” group and how can one ask for it?</a> accordingly if eligible submit the <a href="https://dataspace.copernicus.eu/copernicus-services-user">Change your Copernicus user type form</a>. </li>
        </ul>
    If you run out of <b>openEO related quotas</b> (e.g. openEO credits) within CDSE: 
      <ul>
        <li>Note that these quotas are monthly and will be replenished on the first day of every month. Accordingly, if possible, we suggest waiting until the first day of the coming month.</li> 
        <li>Have a look at <a href="https://documentation.dataspace.copernicus.eu/APIs/openEO/job_config.html">Job Configuration</a> to see if you can optimize your openEO jobs.</li> 
        <li>For scientists and researchers: You can apply for <a href="https://nor-discover.org/en/sponsorship/">ESA NoR Sponsorship</a>. Navigate to <a href="https://portfolio.nor-discover.org/">Network of Resources (NoR) Portfolio</a>, continue with “VITO - Copernicus Data Space Ecosystem and Terrascope – openEO". </li> 
        <li>For entities creating commercial services i.e. start-ups and service providers: You can apply for <a href="https://creodias.eu/pricing/credits-for-value-creators/">Credits for value creators</a>. Navigate to <a href="https://creodias.eu/pricing/credits-for-value-creators/">Credits for value creators</a>, select openEO, and fill out the "Apply for credits" form.</li>
        <li>You can purchase extra openEO Cloud Credits through CREODIAS. Discover openEO Credit Packages here: [Visit CREODIAS](https://ecommerce.creodias.eu/vito){target="_blank"}</li>
        </ul>
      If you run out of <b>Sentinel Hub related quotas</b> (e.g. Sentinel Hub Processing Units (PU)) within CDSE: 
        <ul>
            <li>Note that these quotas are monthly and will be replenished on the first day of every month. Accordingly, if possible, we suggest waiting until the first day of the coming month.</li> 
            <li>You can consider decreasing the Processing Unit (PU) usage by interacting with Sentinel Hub affiliated applications or APIs (e.g. Copernicus Browser) when logged out - whenever possible -. For example, browsing and searching in the Copernicus Browser don't consume PU when carried out after logging out.</li> 
            <li>For scientists and researchers: You can apply for <a href="https://nor-discover.org/en/sponsorship/">ESA NoR Sponsorship</a>. Navigate to <a href="https://portfolio.nor-discover.org/">Network of Resources (NoR) Portfolio</a>, continue with "Sinergise Solutions - EDC".</li> 
            <li>For entities creating commercial services i.e. start-ups and service providers: You can apply for <a href="https://creodias.eu/pricing/credits-for-value-creators/">Credits for value creators</a>. Navigate to <a href="https://creodias.eu/pricing/credits-for-value-creators/">Credits for value creators</a>, select Sentinel Hub, and fill out the "Apply for credits" form.</li>
            <li>You can make use of the commercial provider integrated with CDSE: <a href="https://dataspace.copernicus.eu/ecosystem/services/creodias">CREODIAS</a> offers EO processing services for Sentinel Hub.  Navigate to <a href="https://dataspace.copernicus.eu/ecosystem/services/creodias">CREODIAS</a> and directly contact them. </li>
        </ul>
</details>
