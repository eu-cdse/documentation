...
<details id="can-we-download-the-data-acquired-by-all-sentinel-missions-1-2-3-5P-6-and-the-other-satellites-e-g-meteosat-via-cdse-considering-some-missions-are-not-managed-by-esa-but-by-eumetsat-for-example">
    <summary onclick="handleQuestionClick('can-we-download-the-data-acquired-by-all-sentinel-missions-1-2-3-5P-6-and-the-other-satellites-e-g-meteosat-via-cdse-considering-some-missions-are-not-managed-by-esa-but-by-eumetsat-for-example')">Can we download the data acquired by all Sentinel missions (1, 2, 3, 5P, 6) and the other satellites (e.g. Meteosat) via CDSE? Considering some missions are not managed by ESA, but by EUMETSAT for example.</summary>
...
<details id="will-cdse-offer-eo-ready-to-use-products-or-just-l0-and-l1-data">
    <summary onclick="handleQuestionClick('will-cdse-offer-eo-ready-to-use-products-or-just-l0-and-l1-data')">Will CDSE offer EO ready-to-use products or just L0 and L1 data?</summary>
...
<details id="when-we-develop-an-eo-ready-to-use-product-could-we-integrate-it-into-cdse-and-ask-the-payment-from-clients">
    <summary onclick="handleQuestionClick('when-we-develop-an-eo-ready-to-use-product-could-we-integrate-it-into-cdse-and-ask-the-payment-from-clients')">When we develop an EO ready-to-use product, could we integrate it into CDSE and ask the payment from clients?</summary>
...
<details id="how-to-solve-message-this-request-was-rejected-due-to-a-violation-error-in-openeo">
    <summary onclick="handleQuestionClick('how-to-solve-message-this-request-was-rejected-due-to-a-violation-error-in-openeo')">How to solve Message:"This request was rejected due to a violation" error in openEO?</summary>
