...
<details id="how-can-i-request-deletion-of-my-cdse-account">
    ...
    <p>Please send an email from the related email address to help-login@dataspace.copernicus.eu and mention that you wish to delete your account from CDSE.</p>
</details>
...
<details id="how-can-i-change-my-email-address-in-cdse">
    ...
    <p>The email address is also the account identifier and cannot be changed. Accordingly the only option is registering a new account. <br> To deactivate your old one, send an email from the related email address to to help-login@dataspace.copernicus.eu and mention that you wish to delete your account from CDSE.</p>
</details>
