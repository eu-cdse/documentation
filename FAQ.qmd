...
<details id="what-is-the-citation-format-for-referencing-sentinel-data-downloaded-from-cdse">
    ...
    <p>When referring to Sentinel image(s) acquired through the Copernicus Data Space Ecosystem services, you should credit the image(s) by including the following text citation: “Modified Copernicus Sentinel data [Year] processed in Copernicus Browser”. For further reading you can have a look at the <a href="https://sentinels.copernicus.eu/documents/247904/690755/Sentinel_Data_Legal_Notice" target="_blank">Legal notice on the use of Copernicus Sentinel Data and Service Information</a> or <a href="https://dataspace.copernicus.eu/terms-and-conditions" target="_blank">Copyrights section of the Terms and conditions </a>  (can also be found at the left bottom of CDSE webpage) for more information.</p>
</details>
...
<details id="how-can-i-request-deletion-of-my-cdse-account">
    ...
    <p>Please send an email from the related email address to <a href="mailto:help-login@dataspace.copernicus.eu">help-login@dataspace.copernicus.eu</a> and mention that you wish to delete your account from CDSE. Note that it may take about 1-2 business day(s) for the help-login team to answer your email.</p>
</details>
