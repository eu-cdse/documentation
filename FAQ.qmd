...
<details id="which-users-are-qualified-for-higher-tier-accounts">
    ...
    We would also suggest you check the following content:
        <ul>
            ...
            <li>The <a href="https://dataspace.copernicus.eu/ecosystem/services">Ecosystem developerss</a>, where users can get access to extended quotas under commercial terms.</li> 
      </ul>
</details>
