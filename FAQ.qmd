...
<details>
  <summary>How can I request to change my Copernicus user type from Copernicus General user to Copernicus Services user?  
    ...
    <p>To change your Copernicus user type, submit a request to our support team via <a href= "https://helpcenter.dataspace.copernicus.eu/hc/en-gb/requests/new" target="_blank">Submit a request</a>.  Please select 'Other' for the ‘I have a question about*:’ and provide the following information: 
