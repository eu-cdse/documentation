...
<details id="how-can-i-request-deletion-of-my-cdse-account">
    ...
    <p>Please send an email from the related email address to <a href="mailto:help-login@dataspace.copernicus.eu">help-login@dataspace.copernicus.eu</a> and mention that you wish to delete your account from CDSE.</p>
</details>
...
<details id="how-can-i-change-my-email-address-in-cdse">
    ...
    <p>The email address is also the account identifier and cannot be changed. Accordingly the only option is registering a new account. <br> To deactivate your old one, send an email from the related email address to to <a href="mailto:help-login@dataspace.copernicus.eu">help-login@dataspace.copernicus.eu</a> and mention that you wish to delete your account from CDSE.</p>
</details>
...
<details id="what-is-the-citation-format-for-referencing-sentinel-data-downloaded-from-cdse">
    <summary onclick="handleQuestionClick('whare-to-find-the-citation-guideline-for-using-sentinel-data-downloaded-from-cdse')">What is the citation format for referencing Sentinel data downloaded from CDSE?</summary>
