...
<details id="what-to-do-if-run-out-of-quota">
    ...
    <p>For eligible users (i.e., Copernicus Services users, European institutions, etc.), we recommend filling out the form [Change your Copernicus user type](https://dataspace.copernicus.eu/copernicus-services-user){target="_blank"}.</p>
</details>
