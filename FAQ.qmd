...
<details id="what-to-do-if-run-out-of-quota">
    ...
    If you run out of <b>openEO related quotas</b> (e.g. openEO credits) within CDSE: 
      <ul>
        ...
        <li>You can purchase extra openEO Cloud Credits through CREODIAS. Discover openEO Credit Packages here: [Visit CREODIAS](https://ecommerce.creodias.eu/){target="_blank"}</li>
        </ul>
