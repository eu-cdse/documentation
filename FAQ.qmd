...
<details id="which-users-are-qualified-for-higher-tier-accounts">
    ...
    We would also suggest you check the following content:
        <ul>
            ...
            <li>The <a href="https://dataspace.copernicus.eu/ecosystem/services">Ecosystem service providers</a>, where users can get access to extended quotas under commercial terms.</li> 
      </ul>
</details>
...
<details id="which-entities-are-qualified-to-get-higher-quotas-in-scope-of-copernicus-services-group-and-how-can-one-ask-for-it">
    ...
    In order to request for increased quota, go to this form INSERT LINK and provide the following information:
      <ul>
