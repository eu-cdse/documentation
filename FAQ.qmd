...
<details id="in-comparison-to-the-existing-legacy-copernicus-data-hub-what-will-be-the-free-services-other-than-stac-cog">
    ...
    <p>Compared to the previously existed Copernicus Data Hub, there will be additional APIs - OGC interfaces (WMS, WMTS, WCS), OpenEO, Sentinel Hub API, S3, and others. Please refer to the <a href="https://dataspace.copernicus.eu/#roadmap">Roadmap</a> for more information on the timing of these interfaces.</p>
</details>
...
<details id="what-is-the-citation-format-for-referencing-sentinel-data-downloaded-from-cdse">
    <summary onclick="handleQuestionClick('what-is-the-citation-format-for-referencing-sentinel-data-downloaded-from-cdse')">What is the citation format for referencing Sentinel data downloaded from CDSE?</summary>
    If the image in processed in the Copernicus Browser kindly use the phrase "Contains modified Copernicus Sentinel data [YEAR] for Sentinel data processed in Copernicus Browser"<br><br>
    Where the user communicates to the public or distributes Copernicus Sentinel Data and Service Information, he/she shall inform the recipients of the source of that Data and Information by using the following notice:
        <ul>
            <li>'Copernicus Sentinel data [Year]' for Sentinel data; and/or</li> 
            <li>'Copernicus Service information [Year]' for Copernicus Service Information</li> 
        </ul>
    Where the Copernicus Sentinel Data and Service Information have been adapted or modified, the user shall provide the following notice:
        <ul>
            <li>'Contains modified Copernicus Sentinel data [Year]' for Sentinel data; and/or</li> 
            <li>'Contains modified Copernicus Service information [Year]' for Copernicus Service Information</li> 
      </ul>
    For further reading kindly have a look at the <a href="https://sentinels.copernicus.eu/documents/247904/690755/Sentinel_Data_Legal_Notice" target="_blank">Legal notice on the use of Copernicus Sentinel Data and Service Information</a> or <a href="https://dataspace.copernicus.eu/terms-and-conditions" target="_blank">Copyrights section of the Terms and conditions </a>.
</details>
...
<details id="which-users-are-eligible-for-which-account-types">
    <summary onclick="handleQuestionClick('which-users-are-eligible-for-which-account-types')">Which users are eligible for which account types (Quotas)?</summary>
    There are four account types defined by the <a href="https://documentation.dataspace.copernicus.eu/Quotas.html" target="_blank">Quotas and Limitations</a> policy: Copernicus General user Account, Copernicus Services user Account, Copernicus Collaborative Ground Segment user Account, and Copernicus International user Account. Users can find their user Account type under "Account info" in the <a href="https://shapps.dataspace.copernicus.eu/dashboard/#/">Dashboard</a> page. These user account types determine the quotas and limitations applied to users — for example, Copernicus Services user Accounts receive larger quotas than Copernicus General user Accounts. 
        <ul>
            <li>Copernicus Services user Account- this account type is reserved for European Union institutions and bodies and organisations working on <a href="https://www.copernicus.eu/en/copernicus-services">Copernicus Services</a>.</li> 
            <li>Copernicus Collaborative Ground Segment user Account - Ground segment organisations from Copernicus Participating States with an agreement with ESA and European Commission.</li> 
            <li>Copernicus International user Account- international partners with an agreement with ESA and European Commission.</li> 
        </ul>
    If your organisation matches one of the profiles above, please <a href="https://dataspace.copernicus.eu/copernicus-services-user">fill out the Change your Copernicus user type form</a> to request a user account type upgrade. If you are uncertain about your eligibility, you may still submit the form for evaluation.
    Please note that Copernicus Data Space Ecosystem monitoring requirements include reporting aggregated consumption on account level, shared within project stakeholder group. 
    We would also recommend reviewing following resources:
        <ul>
...
<details id="which-users-are-eligible-for-which-ccm-user-categories">
    <summary onclick="handleQuestionClick('which-users-are-eligible-for-which-ccm-user-categories')">Which users are eligible for which CCM user categories (CCM dataset access)?</summary>
    There are six CCM User categories. These are: Copernicus Services and Union Institutional Users, Union Research Project users, National Public Authority users, International Organisations user, Public user, and Copernicus Operator user. <br><br>
    Users can find their CCM User cateogory under "Copernicus Contributing Missions Category" in the <a href="https://shapps.dataspace.copernicus.eu/dashboard/#/">Dashboard</a> page. Access to CCM datasets is determined by the user’s CCM user category. <br><br>
    For a complete description of each category and the detailed eligibility criteria, please refer to the official CCM User Categories page on the Copernicus Data Space Ecosystem: <a href="https://dataspace.copernicus.eu/explore-data/data-collections/copernicus-contributing-missions/ccm-user-categories">Copernicus Contributing Missions User Categories</a>.
</details>
...
<details id="how-should-i-cite-copernicus-data-space-ecosystem">
    <summary onclick="handleQuestionClick('how-should-i-cite-copernicus-data-space-ecosystem')">How should I cite Copernicus Data Space Ecosystem?</summary>
    <p>For the generic use of Sentinel data, the following legal notice applies: <a href="https://sentinels.copernicus.eu/documents/247904/690755/Sentinel_Data_Legal_Notice">Sentinel Data Legal Notice</a>.If you are using CDSE APIs or discussing CDSE as a source of data, please cite the following paper: <br>Dávid D. Kovács, Jan Musial, Jędrzej Bojanowski, Dennis Clarijs, Jurry de la Mar, and András Zlinszky. "Copernicus Data Space Ecosystem establishes public cloud processing for earth observation data." <i>Scientific Data</i> (2026). doi: <a href="https://doi.org/10.1038/s41597-026-06765-8">10.1038/s41597-026-06765-8</a></p>
</details>
...
<details id="what-data-will-be-offered-online-and-what-is-the-timeline-for-the-following-months">
    ...
    <p>For the details on the data offer and timing, please refer to the <a href="https://dataspace.copernicus.eu/#roadmap">Roadmap</a></p>
</details>

<details id="how-can-i-download-copenicus-data-in-bulk-mode">
    <summary onclick="handleQuestionClick('how-can-i-download-copenicus-data-in-bulk-mode')">How can I download Copernicus data in bulk mode?</summary>
    <p>The Copernicus Data Space Ecosystem (CDSE) provides two official methods for bulk downloading data, including the Copernicus DEM datasets:</p>
    <ol>
    <li>
      <strong>S3-compatible object storage access (recommended for full dataset download)</strong>
      <ul>
        <li>
          Log in to the <a href="https://dataspace.copernicus.eu">CDSE</a>
        </li>
        <li>
          Follow <a href="https://documentation.dataspace.copernicus.eu/APIs/S3.html#generate-secrets">Generate secrets documentation</a>
        </li>
        <li>
          Use the AWS CLI or compatible tools to access the data.
        </li>
      </ul>
    </li>
Further information is available at: <a href="https://documentation.dataspace.copernicus.eu/APIs/S3.html">S3 Access</a>.
    <li>
      <strong>OData API access (recommended for programmatic or filtered downloads)</strong>
      <ul>
        <li>
          Use a valid OAuth2 token to authenticate
        </li>
        <li>
          Filter by collection ID: e.g. COP-DEM_GLO-30-DGED
        </li>
        <li>
          Retrieve all product IDs and submit automated download requests
        </li>
      </ul>
    </li>
  </ol>
  <p>You may also use the CDSE OData API to automate the search and download of products by querying metadata.Further information is available at <a href="https://documentation.dataspace.copernicus.eu/APIs/OData.html">OData API documentation page</a>.<br><br>Both methods are available to all users, data download capability depends on their respective user category.</p>
</details>
...
<details id="can-we-download-the-data-acquired-by-all-sentinel-missions-1-2-3-5P-6-and-the-other-satellites-e-g-meteosat-via-the-cdse-considering-some-missions-are-not-managed-by-esa-but-by-eumetsat-for-example">
    <summary onclick="handleQuestionClick('can-we-download-the-data-acquired-by-all-sentinel-missions-1-2-3-5P-6-and-the-other-satellites-e-g-meteosat-via-the-cdse-considering-some-missions-are-not-managed-by-esa-but-by-eumetsat-for-example')">Can we download the data acquired by all Sentinel missions (1, 2, 3, 5P, 6) and the other satellites (e.g. Meteosat) via the CDSE? Considering some missions are not managed by ESA, but by EUMETSAT for example.</summary>
    <p>The <a href="Rhttps://dataspace.copernicus.eu/#roadmap">Roadmap</a> shows how the Copernicus Data Space Ecosystem will be continously enhanced in terms of available data.</p>
</details>

<details id="will-the-cdse-offer-eo-ready-to-use-products-or-just-l0-and-l1-data">
    <summary onclick="handleQuestionClick('will-the-cdse-offer-eo-ready-to-use-products-or-just-l0-and-l1-data')">Will the CDSE offer EO ready-to-use products or just L0 and L1 data?</summary>
    <p>Up to L3 products will be available. Please see the <a href="https://dataspace.copernicus.eu/#roadmap">Roadmap</a>.</p>
</details>

<details id="can-i-access-landsat-data-in-copernicus-data-space-ecosystem">
    <summary onclick="handleQuestionClick('can-i-access-landsat-data-in-copernicus-data-space-ecosystem')">Can I access Landsat data in Copernicus Data Space Ecosystem?</summary>
    <p>Landsat 8&9 Collection 2 generated by the USGS is available in the CDSE from 2022 onwards via the <a href = "https://documentation.dataspace.copernicus.eu/APIs/S3.html">S3 Protocol</a> at global scale. CDSE users can access Landsat data within the cloud environment only via the <a href = "https://documentation.dataspace.copernicus.eu/APIs/S3.html">S3 protocol</a>, but downloading of Landsat data is not possible. <br>On the contrary, Landsat 5 & 7 & 8 data generated by the ESA is available over Europe in the CDSE from 1984 onwards via the <a href = "https://documentation.dataspace.copernicus.eu/APIs/S3.html">S3 protocol</a>  and <a href = "https://documentation.dataspace.copernicus.eu/APIs/OData.html">OData</a>. Additional development is in progress for further integration, however, there is no plan to support Level-2 data or for supporting full Landsat history prior to 2021.</p>
</details>
...
<details id="what-is-the-highest-resolution-sar-data-available-in-copernicus-data-space-ecosystem">
    ...
    <p>The Sentinel-1 SAR achieves a spatial resolution of approximately 5 by 20 m. More information can be found <a href="https://sentiwiki.copernicus.eu/web/sentinel-1" target="_blank">here</a>.</p>
</details>
...
* Use a [visualizer](https://documentation.dataspace.copernicus.eu/APIs/SentinelHub/Evalscript/Utilities.html#visualizers) or a color visualization function, e.g. [valueInterpolate](https://documentation.dataspace.copernicus.eu/APIs/SentinelHub/Evalscript/Utilities.html#valueinterpolate).</li>
...
* Use a [visualizer](https://documentation.dataspace.copernicus.eu/APIs/SentinelHub/Evalscript/Utilities.html#visualizers) or a color visualization function, e.g. [valueInterpolate](https://documentation.dataspace.copernicus.eu/APIs/SentinelHub/Evalscript/Utilities.html#valueinterpolate).
</details>
...
<details id="how-to-access-COP-DEM-10m">
    ...
    <p><strong>Availability:</strong> COP-DEM 10m is available in the [Copernicus Contributing Missions (CCM) dataset](https://dataspace.copernicus.eu/explore-data/data-collections/copernicus-contributing-missions){target="_blank"} within CDSE. 
    <strong>Restrictions:</strong> Access is limited to eligible CCM User Categories and requires an application.</p>
    <ol>
        <li>
        <strong>Check Eligibility:</strong>
            <ul>
                <li>Kindly visit the [Copernicus Contributing Missions User Categories](https://dataspace.copernicus.eu/explore-data/data-collections/copernicus-contributing-missions/ccm-user-categories){target="_blank"} page.</li>
                <li>Kindly review the table at the bottom to see which categories are eligible for download (D).</li>
                <li>Read the definitions for the categories: C-S-U-I, U-R-P, N-P-A, C-O.</li>
            </ul>
        </li>
        <li>
        <strong>Apply For Access:</strong> If your organization’s email domain matches an eligible category: Follow  the guide: [How to register to access Copernicus Contributing Missions data](https://dataspace.copernicus.eu/explore-data/data-collections/copernicus-contributing-missions/ccm-how-to-register){target="_blank"} by selecting appropriate User Category.
        </li>
        <li>
        <strong>Expect an email:</strong> You’ll receive an email regarding your application within 1 business day.
        </li>
  </ol>
  <p>For further information please consult [ESA-User license for the use of CCM data](https://dataspace.copernicus.eu/sites/default/files/media/files/2025-06/copernicus_contributing_mission_data_access_v2_cop_dem_licenses.pdf){target="_blank"} and [CCM Data Access Restrictions](https://dataspace.copernicus.eu/sites/default/files/media/files/2025-06/ccm_data_access_restrictions_v2.pdf){target="_blank"}. For further assistance, you can reach out to the CDSE Support Team via <a href= "https://helpcenter.dataspace.copernicus.eu/hc/en-gb/requests/new" target="_blank">Submit a request</a>. In your request please provide information such as whether you followed the procedure explained above, and a screenshot from your [Dashboard](https://shapps.dataspace.copernicus.eu/dashboard/#/){target="_blank"}.</p>
</details>
...
<details id="is-there-any-limitation-on-the-maximum-number-of-downloads-at-a-time">
    ...
    <p>Yes, there are quotas and limitations for different user types. For example, the number of concurrent connections limit for the Copernicus General user Account is 4, whereas for the Copernicus Services user Account, it is 20. Please refer to the <a href="Quotas.qmd">Quotas and Limitations</a> section of our documentation for more information regarding quotas and limitations apply to the Copernicus General user Account.</p>
</details>
...
<details id="which-entities-are-qualified-to-get-higher-quotas-in-scope-of-copernicus-services-group-and-how-can-one-ask-for-it">
    <summary onclick="handleQuestionClick('which-entities-are-qualified-to-get-higher-quotas-in-scope-of-copernicus-services-group-and-how-can-one-ask-for-it')">
    ...
    <ul>
        <li>
            Institutions and organisations developing or operating <a href="https://www.copernicus.eu/en/copernicus-services">Copernicus Services</a> under a formal Copernicus mandate or contract (including service operators, entrusted entities, contractors, and subcontractors).
        </li>
        <li>
            European Union institutions and bodies set up under the EU Treaties (such as European Commission services and EU agencies), when acting in the context of <a href="https://www.copernicus.eu/en/copernicus-services">Copernicus Services</a> development or operations.
        </li>
    </ul>
    Public authorities at national, regional, or local level (e.g. ministries of EU Member States, regional agencies, or municipal governments) are <strong>not automatically eligible</strong> for Copernicus Services–level quotas solely based on their public-sector status.
    Such entities may qualify only if they are formally operating or contributing to a <a href="https://www.copernicus.eu/en/copernicus-services">Copernicus Services</a> under an official mandate or contract.<br>
    Each institution or project can have several individuals' user accounts, which belong to the same organisation and share the account's quota (i.e. if one of the organisation users consumes the full monthly or rolling quota, the remaining users will not be able to use it further during that period).
    <br>
    Organisations can choose the account type based on their preference, i.e. download-optimised or processing-optimised:
    <ul>
        <li>Download</li>
    ...
    In order to request an increased quota, please <a href="https://dataspace.copernicus.eu/copernicus-services-user">fill out this Change your Copernicus user type form</a>.
    <br>
    Please note that Copernicus Data Space Ecosystem monitoring requirements include reporting of aggregated consumption at organisation level.
</details>
...
<details id="what-to-do-if-run-out-of-quota">
    <summary onclick="handleQuestionClick('what-to-do-if-run-out-of-quota')">
        What can I do if I run out of download quota, processing units, or requests?
    </summary>

    Every user account is set with a limited quota to guarantee fair sharing of free tier resources within all users of the Copernicus Data Space Ecosystem (CDSE).<br>

    The total volume of downloads from the CDSE for each user account is summed up for the last 30 days. The downloaded volume is checked on an hourly basis, and if it exceeds the assigned quota, the user will be moved to a slower interface. Such users will still be able to access and download products but at a reduced speed.
    More information about the quotas and limitations is also available in
    <a href="https://documentation.dataspace.copernicus.eu/Quotas.html">Quotas and Limitations</a>.
    <br>

    If you run out of <b>download quota (e.g. S3 / OData)</b>, you can consider the following options:
    <ul>
        <li>
            <b>Eligibility for higher quotas via Copernicus Services:</b>
            EU government agencies, public bodies, and entities developing or operating <a href="https://www.copernicus.eu/en/copernicus-services">Copernicus Services</a> may be eligible for higher quotas.
            See <a href="https://documentation.dataspace.copernicus.eu/FAQ.html#which-users-are-eligible-for-which-account-types">Which users are eligible for which account types (Quotas)</a> and <a href="https://documentation.dataspace.copernicus.eu/FAQ.html#which-entities-are-qualified-to-get-higher-quotas-in-scope-of-copernicus-services-group-and-how-can-one-ask-for-it">Which entities are qualified to get higher quotas in scope of “Copernicus Services”</a>. If eligible, submit the <a href="https://dataspace.copernicus.eu/copernicus-services-user">Change your Copernicus user type</a>
            form.
        </li>
        <li>
            <b>Commercial access:</b>
            You can make use of the commercial provider integrated with CDSE. Please visit the page <a href="https://dataspace.copernicus.eu/ecosystem/services/creodias">CREODIAS</a>, and directly contact them.
        </li>
    </ul>

    If you run out of <b>openEO related quotas</b> (e.g. openEO credits) within CDSE:
    <ul>
        <li>
            Note that these quotas (i.e. free) are monthly and will be replenished on the first day of every month.
            Accordingly, if possible, we suggest waiting until the first day of the coming month.
        </li>
        <li>
            Have a look at <a href="https://documentation.dataspace.copernicus.eu/APIs/openEO/job_config.html">Job Configuration</a> to see if you can optimize your openEO jobs.
        </li>
        <li>
            Entities creating commercial services (including start-ups and service providers) may apply for <a href="https://creodias.eu/pricing/credits-for-value-creators/">Credits for value creators</a>.
            Navigate to <a href="https://creodias.eu/pricing/credits-for-value-creators/">Credits for value creators</a>, select openEO, and fill out the “Apply for credits” form.
        </li>
        <li>
            <b>Commercial access:</b>
            You can purchase extra openEO Cloud Credits through CREODIAS.
            Discover openEO Credit Packages here: <a href="https://ecommerce.creodias.eu/vito" target="_blank">Visit CREODIAS</a>.
        </li>
    </ul>

    If you run out of <b>Sentinel Hub related quotas</b> (e.g. Sentinel Hub Processing Units (PU)) within CDSE:
    <ul>
        <li>
            Note that these quotas are monthly and will be replenished on the first day of every month.
            Accordingly, if possible, we suggest waiting until the first day of the coming month.
        </li>
        <li>
            You can consider decreasing the Processing Unit (PU) usage by interacting with Sentinel Hub affiliated applications or APIs (e.g. Copernicus Browser) when logged out whenever possible.
            For example, browsing and searching in the Copernicus Browser do not consume PU when carried out after logging out.
        </li>
        <li>
            Entities creating commercial services (including start-ups and service providers) may apply for <a href="https://creodias.eu/pricing/credits-for-value-creators/">Credits for value creators</a>.
            Navigate to <a href="https://creodias.eu/pricing/credits-for-value-creators/">Credits for value creators</a>, select Sentinel Hub, and fill out the “Apply for credits” form.
        </li>
        <li>
            <b>Commercial access:</b>
            You can make use of the commercial provider integrated with CDSE: Navigate to <a href="https://dataspace.copernicus.eu/ecosystem/services/creodias">CREODIAS</a> offers EO processing services for Sentinel Hub and directly contact them.
        </li>
    </ul>
</details>

<details id="openEO-credits-refund">
    <summary onclick="handleQuestionClick('openEO-credits-refund')">How can I request a refund for openEO credits?</summary>
    
    <p>If jobs fail due to an error on the provider side, the user can be refunded for the credits used by these jobs. A user can fill in a <a href="https://dataspace.copernicus.eu/openeo-refund-request">refund request form</a>. The form requires the user to provide details about the job(s), such as the job ID and a timeframe of failed jobs. The request will be reviewed by the support team, and if approved, the credits used for that job and similar jobs in the same timeframe will be refunded to the user's account. This is possible for all types of credits except for the free tier credits, which are not refundable.</p>
</details>

<details id="typical-conversions-processing-units">
    <summary onclick="handleQuestionClick('typical-conversions-processing-units')">What are typical conversions between processing units and square kilometers?</summary>
...
| Orthorectification                       | Yes                         | x2                     |
    ...
    <p>If your output image were smaller, e.g. 500 x 500 px large, the cost of a single request would be 1.27 PU. Multiplied by 500, that’s just 635.78 PU in total, so much less. On the other hand, if you wanted an image with quite a large output of 5000 x 5000 px, a request would cost you 127.15 PU, and 500 of these would cost ~63,578 PU. However, processing API is limited to output images with width and height up to 2500 px, so setting it to 5000 would result in an error. To output images this large, you would need a **Copernicus Service user Account** or a commercial Sentinel Hub account and bucket on [CREODIAS](https://creodias.eu/eobased-services/sentinel-hub/){target="_blank"} to use batch processing API. You will notice that batch processing divides your PU cost by 3, as it’s only a third of the price of processing API. So your 500 requests would cost 63,578 / 3 = 21,192 PU.</p>
...
| Orthorectification                       | Yes                         | x2                     |
    ...
    <p>The issue here is that you would use more than 2,000 PU in a single minute, as it’s just one request, and use this heavy isn’t supported by any package. Each package specifies how many PUs and requests you can use per month, as well as per minute. Your request would time out or fail. If you’re interested in very large time ranges, it’s best to use [batch processing API](https://documentation.dataspace.copernicus.eu/APIs/SentinelHub/BatchV2.html).</p>
...
<details id="im-having-troubles-with-registering-what-can-I-do">
    ...
    <p>If you are having troubles with Recaptcha or receiving the initial confirmation email while registering, please send an e-mail to <a href="mailto:help-login@dataspace.copernicus.eu">help-login@dataspace.copernicus.eu</a> for direct support. Note that it may take about 1-2 business day(s) for the help-login team to answer your email.</p>
</details>

<details id="how-can-i-request-deletion-of-my-cdse-account">
    <summary onclick="handleQuestionClick('how-can-i-request-deletion-of-my-cdse-account')">How can I request deletion of my CDSE account?</summary>
    <p>Please send an email from the related email address to <a href="mailto:help-login@dataspace.copernicus.eu">help-login@dataspace.copernicus.eu</a> and mention that you wish to delete your account from CDSE. Note that it may take about 1-2 business day(s) for the help-login team to answer your email. For further reading please see Opt-out section of the [Privacy policy](https://dataspace.copernicus.eu/privacy-policy){target="_blank"} page.</p>
</details>

<details id="how-can-i-change-my-email-address-in-cdse">
    <summary onclick="handleQuestionClick('how-can-i-change-my-email-address-in-cdse')">How can I change my email address in CDSE?</summary>
    <p>The email address is also the account identifier and cannot be changed. Accordingly the only option is <a href= "https://documentation.dataspace.copernicus.eu/Registration.html" target="_blank">registering</a> a new account. <br> To deactivate your old one, send an email from the related email address to <a href="mailto:help-login@dataspace.copernicus.eu">help-login@dataspace.copernicus.eu</a> and mention that you wish to delete your account from CDSE. Note that it may take about 1-2 business day(s) for the help-login team to answer your email.</p>
</details>
...
<details id="will-long-term-zrchive-lta-process-be-discontinued-when-all-archived-data-become-online">
    ...
    <p>There will still be services available for so called “deferred data access” :  data collections that are not commonly used. That said, all of the most relevant collections will be available Online. The <a href="https://dataspace.copernicus.eu/#roadmap">Roadmap</a> shows how the Copernicus Data Space Ecosystem will be continously upgraded and how more data become available.</p>
</details>
...
<details id="will-the-platform-use-stac-standards">
    ...
    <p>Yes, the platform is already using STAC standards, with a full STAC product catalog available at <a href= "https://documentation.dataspace.copernicus.eu/APIs/STAC.html" target="_blank">STAC Product Catalog</a> and also a new STAC catalog with generic libraries. You can find the new STAC catalog browser here: <a href= "https://browser.stac.dataspace.copernicus.eu/?.language=en" target="_blank">Copernicus Data Space Ecosystem (CDSE) - STAC API</a>.</p>
</details>
...
<details id="which-catalog-api-is-updated-first-when-new-products-are-published">
    <summary onclick="handleQuestionClick('which-catalog-api-is-updated-first-when-new-products-are-published')">Which catalog API is updated first when new products are published?</summary>
    <p>OData and STAC catalog APIs all use the same backend database. Sentinel Hub catalog API contains a subset of the collections, hence it works only for the ones that have been imported to Sentinel Hub. Therefore there is no first updated one.</p>
</details>
...
<details id="how-to-troubleshoot-message-this-request-was-rejected-due-to-a-violation">
    <summary onclick="handleQuestionClick('how-to-troubleshoot-message-this-request-was-rejected-due-to-a-violation')">How to troubleshoot Message:"This request was rejected due to a violation"?</summary>
...
<details id="what-is-the-benefit-of-fetching-imagery-from-copernicus-dataspace-s3-bucket">
    ...
    <p>Downloading products via S3 is faster as it delivers products as a .zip archive, skipping the need of zipping.</p>
</details>
...
<details id="how-can-I-search-for-the-product-in-s3-bucket">
    ...
    <p>Searching via ID or product name in OData will give the S3 path to the product in response.</p>
</details>
...
<details id="are-there-tutorials-online-physical-meetings-to-use-the-cdse">
    <summary onclick="handleQuestionClick('are-there-tutorials-online-physical-meetings-to-use-the-cdse')">Are there tutorials (online & physical meetings) to use the CDSE?</summary>
    We have a set of tutorials, including the <a href = "https://www.youtube.com/@copernicusdataspaceecosystem">Copernicus Data Space Ecosystem YouTube channel</a>:
    <ul>
        <li>with an introduction to the Copernicus Browser: <a href = "https://www.youtube.com/watch?v=F0lIn5r6ZWk">A short guide to Copernicus Browser</a>,</li> 
        <li>an introduction to Jupyter: <a href = "https://www.youtube.com/watch?v=QVla6BT4eeA">From Copernicus Browser to Jupyter Notebook</a>,</li>
        <li>a playlist on <a href = "https://www.youtube.com/playlist?list=PLj4KwRQTBlPL3CVwpaBXl3VrO0_V3VX_Q">Introduction to Sentinel Hub APIs on Copernicus Data Space Ecosystem</a> and</li> 
        <li>an introduction to openEO: <a href = "https://www.youtube.com/watch?v=jCg4u8gPxlA">EU Space Webinar - CDSE: The openEO API</a>.</li>
    </ul>    
    We regularly organize webinars which are announced in the <a href = "https://dataspace.copernicus.eu/events">Events</a> page and on our social media. Previous webinars can be found on <a href = "https://www.youtube.com/playlist?list=PLj4KwRQTBlPJGkEPQvYIF--Jq9BKNPuYv">Copernicus Data Space Ecosystem YouTube channel - Webinars</a>.<br><br>
    We also have tutorial notebooks in the <a href = "https://github.com/eu-cdse/notebook-samples/">notebook-samples repository</a>. These are: 
    <ul>
        <li><a href = "https://github.com/eu-cdse/notebook-samples/tree/main/openeo">openEO</a>,</li> 
        <li><a href = "https://github.com/eu-cdse/notebook-samples/tree/main/sentinelhub">Sentinel Hub</a>,</li> 
        <li><a href = "https://github.com/eu-cdse/notebook-samples/tree/main/stac">STAC</a>.</li>
    </ul>
</details>
...
<details id="where-can-i-learn-more-about-the-copernicus-browser">
    ...
    <p>You can find an online tutorial in our documentation in the <a href = "https://documentation.dataspace.copernicus.eu/Applications/Browser.html">About the Browser</a> page and a short introductory video here: <a href = "https://www.youtube.com/watch?v=F0lIn5r6ZWk">A short guide to Copernicus Browser</a>.</p>
</details>

<details id="can-i-add-my-own-wms-or-wmts-services-to-copernicus-browser">
    <summary onclick="handleQuestionClick('can-i-add-my-own-wms-or-wmts-services-to-copernicus-browser')">Can I add my own WMS or WMTS services to Copernicus Browser?</summary>
    <p>Yes. Open the <em>WMS/WMTS panel</em> from the collection selection area of the <em>Visualization</em> tab, paste the service (GetCapabilities) URL, and press Enter or click the add button. The service's layers can then be visualized, queried, pinned and compared. WMS 1.1.1 and WMTS 1.0.0 are supported; the service must be served over HTTPS and allow cross-origin (CORS) access. For details see <a href="https://documentation.dataspace.copernicus.eu/Applications/Browser.html">the Copernicus Browser documentation</a>.</p>
</details>
...
* Make sure to set the appropriate date and zoom in to the area where ta is available.
...
<details id="why-am-i-getting-network-error-in-the-copernicus-browser">
    ...
    If the issue persists: the quickest workaround can be using the <a href="https://documentation.dataspace.copernicus.eu/Applications/DataWorkspace.html" target="_blank">Data Workspace</a>.<br>
    Other download methods such as <a href="https://documentation.dataspace.copernicus.eu/APIs/S3.html" target="_blank">S3 Access</a> or <a href="https://documentation.dataspace.copernicus.eu/APIs/OData.html" target="_blank">OData</a> also can be used as a workaround. <br>
...
<details id="how-can-i-stream-sentinel-2-cloudless-mosaics-to-my-gis-application">
    <summary onclick="handleQuestionClick('how-can-i-stream-sentinel-2-cloudless-mosaics-to-my-gis-application')">How can I stream Sentinel-2 cloudless mosaics to my GIS application?</summary>

There are a couple of options.
    
1. If you want to use OGC APIs (i.e. WMTS), follow these steps:
    <ul>
        <li>Create a new configuration in the <a href="https://shapps.dataspace.copernicus.eu/dashboard/" target="_blank">Sentinel Hub Dashboard</a>, best following <a href="https://dataspace.copernicus.eu/news/2023-9-26-customising-your-copernicus-browser-experience" target="_blank">these steps</a>. When creating a new layer, select “Bring your own COG”, use collection id byoc-5460de54-082e-473a-b6ea-d5cbe3c17cca and custom script as shown <a href="https://documentation.dataspace.copernicus.eu/notebook-samples/sentinelhub/cloudless_process_api.html#example-1-true-color-image" target="_blank">here</a>.</li>
        <li>You will then be able to access WMTS at the following URL, replacing INSTANCE_ID with ID of your configuration: <a href="https://sh.dataspace.copernicus.eu/ogc/wmts/INSTANCE_ID" target="_blank">https://sh.dataspace.copernicus.eu/ogc/wmts/INSTANCE_ID</a></li>
    </ul>
<br>        
2. For even better experience, if you are able to, use Process API as shown <a href="https://documentation.dataspace.copernicus.eu/APIs/SentinelHub/Process/Examples/BYOC.html#create-a-true-color-image-from-the-gathered-bands" target="_blank">here</a>. You can then also use a combination of STAC API to get the available dates for the imagery, as shown in <a href="https://documentation.dataspace.copernicus.eu/APIs/SentinelHub/Catalog/Examples.html#search-with-distinct" target="_blank">this example</a>.    

</details>

<details id="can-i-load-and-view-data-from-cdse-on-my-smartphone">
    <summary onclick="handleQuestionClick('can-i-load-and-view-data-from-cdse-on-my-smartphone')">
        Can I load and view data from CDSE on my smartphone?
    </summary>
    <p>There are two options:</p>
    <ul>
        <li>
            <strong>Use Copernicus Browser Display Wall</strong><br>
            If you want to view or show a couple of your favourite places, or browse Sentinel-1 and Sentinel-2 data with basic visualisations, Copernicus Browser Display Wall is a quick option.
            <ul>
                <li>Log in to Copernicus Browser and add your locations and images of interest to your pins.</li>
                <li>Go to <a href="https://display-wall.dataspace.copernicus.eu">display-wall.dataspace.copernicus.eu</a> and log in.</li>
                <li>Your pin collection will load and start displaying.</li>
                <li>Touch the right side of the screen, a search bar will appear and you can search for your target area.</li>
                <li>You will see a list of recent Sentinel-2 and Sentinel-1 imagery, select your preferred date.</li>
                <li>When the image loads, you can choose a visualisation layer on the right sidebar.</li>
                <li>For more information, visit:
                    <a href="https://dataspace.copernicus.eu/news/2025-1-28-copernicus-display-wall-showing-satellite-images-easier-ever">
                        Copernicus Display Wall article
                    </a>
                </li>
            </ul>
        </li>
        <li>
            <strong>Use smartphone apps with WMS support (e.g., Locus Map Free)</strong><br>
            If you want to connect CDSE datasets to your GPS position (e.g., for planning a route or identifying features nearby), you can use smartphone outdoor applications compatible with a WMS service.
            <ul>
                <li>
                    Select a configuration in 
                    <a href="https://shapps.dataspace.copernicus.eu/dashboard/#/">
                        CDSE Sentinel Hub Dashboard
                    </a>, 
                    or create your own configuration from your preferred satellite or CLMS dataset:
                    <a href="https://dataspace.copernicus.eu/news/2023-9-26-customising-your-copernicus-browser-experience">
                        Customising your Copernicus Browser experience
                    </a>
                </li>
                <li>Create a WMS/WMTS link for your configuration in the "Service Endpoint" dropdown menu.</li>
                <li>Add a new WMS layer to your application.</li>
                <li>
                    You can find a detailed guide here:
                    <a href="https://www.locusmap.app/how-to-load-free-satellite-imagery-in-locus-map/">
                        How to load free satellite imagery in Locus Map
                    </a>
                </li>
            </ul>
        </li>
...
<details id="which-functions-are-supported-in-custom-scripts">
    ...
    <p>Custom Script integrates [Chrome V8 JavaScript engine](https://developers.google.com/v8/), so the vast majority of the functions supported there can be used in Custom Script as well. Some of the functions that can be used with our custom scripts are described in our [Evalscript V3 documentation](https://documentation.dataspace.copernicus.eu/APIs/SentinelHub/Evalscript/Utilities.html).</p>
