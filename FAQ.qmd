...
<details id="what-is-the-phase-out-timing-for-the-current-Copernicus-Data-Hub-distribution-services">
    <summary onclick="handleQuestionClick('what-is-the-phase-out-timing-for-the-current-Copernicus-Data-Hub-distribution-services')">What is the phase-out timing for the current Copernicus Data Hub distribution services?</summary>
    <p>The legacy Copernicus Data Hub distribution service will remain in operations until end of June 2023 to allow a smooth migration to the new Copernicus Data Space Ecosystem by all user communities. The Copernicus Data Hub distribution service will continue offering access to Sentinel data with a gradual ramp-down of the operations capacity and data offering until end of September 2023.</p>
</details>
...
<details id="in-comparison-to-the-existing-legacy-copernicus-data-hub-what-will-be-the-free-services-other-than-stac-cog">
    ...
    <p>Compared to existing Copernicus Data Hub, there will be additional APIs - OGC interfaces (WMS, WMTS, WCS), OpenEO, Sentinel Hub API, S3, and others. Please refer to the <a href="Roadmap.md">Roadmap</a> for more information on the timing of these interfaces.</p>
</details>
...
<details id="how-long-is-the-project-timescale-in-total">
    ...
    <p>The time scale of the project is 6 years (i.e. to the end of 2028) with an optional extension up to 4 years (i.e. 2032).</p>
</details>
...
<details id="can-anyone-outside-from-Europe-have-free-access-to-any-data">
    ...
    <p>Yes, data and services will be available to users worldwide. You can visit <a href="https://dataspace.copernicus.eu/terms-and-conditions" target="_blank">Terms and Conditions</a> for more information.</p>
</details>
...
<details id="will-data-such-as-sentinel-2-be-processed-to-a-consistent-version">
    ...
    <p>The Sentinel-2 data will be available at the latest processing baseline. And with the reprocessing of Sentinel-2 happening in parallel (out of scope of this project), these will become available on this service as well.</p>
</details>
...
<details id="when-online-data-is-mentioned-does-that-mean-the-data-are-not-on-tape">
    ...
    <p>The Online data or Immediate Access Data (IAD) we are referring to, are indeed not on the tapes. Tapes will still be there for redundancy reasons.</p>
</details>
...
<details id="can-we-download-the-data-acquired-by-all-sentinel-missions-1-2-3-5P-6-and-the-other-satellites-e-g-meteosat-via-the-new-interface-considering-some-missions-are-not-managed-by-esa-but-by-eumetsat-for-example">
    ...
    <p>Initially Sentinel 1, 2, 3, 5P and Belgian Collaborative Ground Segment hosted data are planned to be available. The <a href="https://documentation.dataspace.copernicus.eu/Roadmap/DataTable.html">Data Roadmap</a> shows how the Copernicus Data Space Ecosystem will be continously upgraded and how more data will become available.</p>
</details>

<details id="will-it-still-be-the-case-that-data-is-labelled-as-online-Offline-on-the-current-legacy-portal">
    <summary onclick="handleQuestionClick('will-it-still-be-the-case-that-data-is-labelled-as-online-Offline-on-the-current-legacy-portal')">Will it still be the case that data is labelled as “Online/Offline" on the current legacy portal?</summary>
    <p>Yes, however the vast majority of the data will be Online: all Sentinel-2 L1C/L2A, Sentinel-1 SLC/GRD and just about all other relevant data collections.</p>
</details>
...
<details id="will-the-new-interface-offer-eo-ready-to-use-products-or-just-l0-and-l1-data">
    ...
    <p>Up to L2 products will be available. The <a href="Roadmap.md">Roadmap</a> shows how the Copernicus Data Space Ecosystem will be continuously upgraded and how more data become available.</p>
</details>
...
<details id="is-it-possible-to-acquire-compressed-data">
    ...
    <p>Copernicus Data Space Ecosystem provides access to EO data in zip format without compression.</p>
</details>
...
<details id="when-we-develop-an-eo-ready-to-use-product-could-we-integrate-it-into-the-interface-and-ask-the-payment-from-clients">
    ...
    <p>Yes, commercial services can be built on top, similar to Copernicus Open License.</p>
</details>
...
<details id="how-can-I-request-to-change-my-copernicus-user-type-from-copernicus-general-user-to-copernicus-services-user">
    <summary onclick="handleQuestionClick('how-can-I-request-to-change-my-copernicus-user-type-from-copernicus-general-user-to-copernicus-services-user')">How can I request to change my Copernicus user type from Copernicus General user to Copernicus Services user?</summary>
...
<details id="im-having-troubles-with-registering-what-can-I-do">
    ...
    <p>Please send an e-mail to <a href="mailto:help-login@dataspace.copernicus.eu">help-login@dataspace.copernicus.eu</a> for direct support on this matter.</p>
</details>
