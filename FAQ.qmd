...
<details>
  <summary>How can I request to change my Copernicus user type (e.g. 'Copernicus general user' -> 'Copernicus service user')?  
    ...
    <p>For detailed information about the eligibility and quotas allocated to Copernicus user types, we recommend referring to the Service Description and Evolution document available on our documentation portal. The quotas information can be found in Annex B. The document can be found at <a href= "https://documentation.dataspace.copernicus.eu/Roadmap.html" target="_blank">https://documentation.dataspace.copernicus.eu/Roadmap.html </a>. The quotas information can be found in Annex B.
    </p>
