...
<details id="why-am-i-getting-network-error-in-the-copernicus-browser">
    ...
    <p>The "Network Error" is shown due to numerous reasons such as related to one's network (due to using hotspot / VPN, or restrictions in school/company network). Most of the time the Network Error is solved by applying the following(s):
        <ul>
    ...
    <p>In some cases Network Error is related users' network settings. For those cases you can check the following and consult your organisation's IT / Network department:
        <ul>
            <li>Try again by using another network (e.g. home, work, another).</li>
            <li>Try again by using mobile hotspot.</li>
        </ul>
    </p>
    <p>Please note that there are also other download methods such as <a href="https://documentation.dataspace.copernicus.eu/APIs/S3.html" target="_blank">S3 Access</a> or <a href="https://documentation.dataspace.copernicus.eu/APIs/OData.html" target="_blank">OData</a>. </p>
</details>
