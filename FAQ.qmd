...
* Map the NDVI values to the 0–1 interval in the <code>evaluatePixel()</code> function, 
...
* Use a visualizer or a color visualization function, e.g. <code>valueInterpolate</code>.</li>
...
* Use a visualizer or a color visualization function, e.g. <code>valueInterpolate</code>.
</details>
