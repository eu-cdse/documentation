...
<details id="can-i-add-my-own-wms-or-wmts-services-to-copernicus-browser">
    ...
    <p>Yes. Open the <em>WMS/WMTS panel</em> from the collection selection area of the <em>Visualization</em> tab, paste the service (GetCapabilities) URL, and press Enter or click the add button. The service's layers appear alongside the Copernicus collections and can be visualized, queried, pinned and compared. WMS 1.1.1 and WMTS 1.0.0 are supported; the service must be served over HTTPS and allow cross-origin (CORS) access. For details see <a href="https://documentation.dataspace.copernicus.eu/Applications/Browser.html">the Copernicus Browser documentation</a>.</p>
</details>
