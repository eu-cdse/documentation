...
When clicking on it, a window emerges next to the interface, as shown below:

![](./_images/joblogs.png)

Moreover, users can use openEO processes like inspect that will allow you to log your own information to be displayed in the job logs.
