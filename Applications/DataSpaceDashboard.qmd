...
![](_images/Icons/Dashboard_IconLine.png) . The chart transforms into a line chart, giving you a historical data overview.
...
There is something special on the [Service Health page](https://dashboard.dataspace.copernicus.eu/#/service-health){target="_blank"}. Each service has its own “Availability Timeline”. Simply click on the icon ![](_images/Icons/Dashboard_IconClock.png) next to any service. You will see the availability of that service over time.
...
News is available by clicking on the icon on the bottom right corner ![](_images/Icons/Dashboard_IconSpeaker.png)  to open an overview. A quick look reveals the most recent news with an option to read more: “Show all news”.

## Settings

Settings are available next to the News by clicking on the icon on the bottom right corner:

![](_images/Icons/Dashboard_IconSettings.png) 
