...
Detailed examples of some well-known services and how they fit into the 1000 free credits can further be found [here](PlazaDetails/Strength.qmd).

Moreover, every user is provided with 1000 credits each month, with which they can [execute multiple services](PlazaDetails/ExecuteService.qmd). 
