...
aliases: 
  ...
  - "/Applications/PlazaDetails/Introduction.html"
  - "/Applications/PlazaDetails/Overview.html"
  - "/Applications/PlazaDetails/SignIn.html"
---
...
Credits are deducted based on the chosen services and spatial extent.The amount will vary depending on the processing complexity and time required for each type of service. Detailed examples of some well-known services and how they fit into the 3000 free credits can further be found [here](PlazaDetails/Strength.qmd).
