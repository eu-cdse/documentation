...
<img src="Developers/EOplaza/fig/sign_up.png" alt="Sign In"
width="800" height="400" />
</div>

<div style="width: 100%; text-align: center">
<img src="Developers/EOplaza/fig/login.png" alt="Login"
width="800" height="400" />
</div>
...
[EGI check-in](https://www.egi.eu/services/check-in/){target="_blank"},
provided by the [EGI Foundation](https://egi.eu){target="_blank"}. 
...
you can consult the [EGI Documentation](https://docs.egi.eu/documentation/333/users/check-in/signup/){target="_blank"}, which contains a step-by-step guide with pictures.
