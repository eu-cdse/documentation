...
---
The openEO Algorithm Plaza also provides a self-service onboarding wizard that enables users to publish their services effortlessly. It assigns a [service maturity](../AlgorithmPlaza.qmd#service-maturity-levels) label to each onboarded service.
...
> If you are a member of multiple organisations and wish to publish an algorithm from a specific organisation, ensure you are logged in to that particular organisation. You can verify this by navigating to the [profile page](../AlgorithmPlaza.qmd) and, if necessary, [switch](ManageOrg.qmd#switch-between-organisation) your 'Linked Organization'.
