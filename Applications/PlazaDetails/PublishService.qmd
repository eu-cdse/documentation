...
> If you are a member of multiple organisations and wish to publish an algorithm from a specific organisation, ensure you are logged in to that particular organisation. You can verify this by navigating to the [profile page](https://portal.terrascope.be/profile){target="_blank"} and, if necessary, [switch](ManageOrg.qmd#switch-between-organisation) your 'Linked Organization'.
