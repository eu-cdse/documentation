...
##### NDVI
To calculate the Normalized Difference Vegetation Index (NDVI), approximately 250 NDVI images can be acquired, each covering an area of 1 hectare. Thus, one NDVI image patch of 1-hectare costs 3-5 credits.

##### NDII
The computation of the Normalized Difference Infrared Index (NDII) offers insight into the water content in plant canopies. Using the openEO algorithm, plaza NDII service normally requires 4-8 credits per hectare area. Therefore, with 1000 credits, NDII computation can cover an area of approximately 117 hectares.
