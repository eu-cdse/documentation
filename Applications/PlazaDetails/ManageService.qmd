...
In order to upgrade the level of service, service providers should improve their services and documentation in such a way that it meets the criteria ([here](Developers\openEO algorithm plaza\Guides\ServiceMaturity.md)) for the desired levels. Then a request can be sent to the [openEO algorithm plaza]((mailto:eoplaza@terrascope.be)) support team for upgrading the service. 
...
<p align="center">
<img src="Developers/EOplaza/fig/service_private.png" alt="openEO algorithm plaza - Publishing settings"
width="800" />
</p>
...
<p align="center">
<img src="Developers/EOplaza/fig/service_remove.png" alt="openEO algorithm plaza - Remove service"
width="800" />
</p>
