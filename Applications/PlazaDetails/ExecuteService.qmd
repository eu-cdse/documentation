...
The full documentation on how to use the web editor can be found [in this section](../WebEditor.qmd) of the documentation. Additionally, below are some additional resources to help users get started with the web editor:
...
Furthermore, in the example above, the usage of the `datacube_from_process` function to execute the service is observed. This function requires the ID and namespace of the service, both provided in the service description on the openEO Algorithm Plaza. For comprehensive documentation on using this function, please refer to [openEO documentation](https://open-eo.github.io/openeo-python-client/datacube_construction.html#datacube-from-process){target="_blank"}.
