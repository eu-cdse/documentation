...
There is a limitation when executing a service (User Defined Processes) with Copernicus Dataspace Ecosystem, that it only works from 2017 or so onwards. Moreover, it is recommended to test it for multiple consecutive years.
