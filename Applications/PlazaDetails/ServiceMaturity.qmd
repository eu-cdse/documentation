...
If a service meets the criteria for a higher level, an upgrade can be requested at any time after its publication. However, it's important to note that every criterion must be satisfied before an upgrade can be approved.
...
Based on the fulfilment of the above criteria, users can request an upgrade of the service by submitting a ticket at our [help center](https://helpcenter.dataspace.copernicus.eu/hc/en-gb).
