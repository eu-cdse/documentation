...
Based on the fulfilment of the above criteria, developers can request an advancing the maturity level via [submitting a request](https://helpcenter.dataspace.copernicus.eu/hc/en-gb/requests/new). In your request please mention the page <a href="https://documentation.dataspace.copernicus.eu/Applications/PlazaDetails/ServiceMaturity.html#requesting-a-change-of-the-maturity-level" target="_blank">Requesting a change of the maturity level</a> and provide explanation based on abovementioned criteria.
