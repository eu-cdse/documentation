...
Based on the fulfilment of the above criteria, developers can request an upgrade of the level by [Submitting a request](https://helpcenter.dataspace.copernicus.eu/hc/en-gb/requests/new). In your request please mention 
[Requesting a change of the maturity level](https://documentation.dataspace.copernicus.eu/Applications/PlazaDetails/ServiceMaturity.html#requesting-a-change-of-the-maturity-level).