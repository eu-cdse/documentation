...
<details>
  <summary>Comparing with existing legacy Copernicus Data Hub, what will be the other free services other than stac/cog already described above?</summary>
    <div>
    Compared to existing Copernicus Data Hub, there will indeed be additional APIs - OGC interfaces (WMS, WMTS, WCS), OpenEO, Sentinel Hub API, S3, and others. Please refer to the [Link to Road Map] for more info on the timing of these interfaces.
    </div>
</details>
<details>
  <summary>Is there an end user document available online that describes the specific data products available and specific services?</summary>
    <div>
    The user level document describing the details for every service and dataset can be found HERE (link to user level document once finished)
    </div>
</details>
<details>
...
<details>
  <summary>What data will be offered online and what is the timeline for the following months?</summary>
    <div>
    For the details on the data offer and timing, we would like to refer to the [Link to ROAD MAP]
    </div>
</details>
<details>
...
<details>
  <summary>Is it possible to download a subset of data corresponding to an AOI, instead of the whole image?</summary>
    <div>
    Yes, you will be able to download a subset of data, either using S3 interface, or dedicated APIs, i.e. Sentinel Hub, OpenEO when they become available. See [Link to ROAD MAP] section of the documentation.
    </div>
</details>
<details>
...
<details>
  <summary>Can we download the data acquired by all Sentinel missions (1, 2, 3, 5P, 6) and the other satellites (ex., Meteosat) via the new interface? Some missions are not managed by ESA, but by EUMETSAT for example.</summary>
    <div>
    Initialy data up to L2 products will be available.  The [Link to ROAD MAP] shows how the Copernicus Data Space Ecosystem will be continously upgraded and how more data become available.
    </div>
</details>
<details>
...
<details>
  <summary>Will the new interface offer EO ready-to-use products or just L0 and L1 data?</summary>
    <div>
    Up to L2 products will be available. The [Link to ROAD MAP] shows how the Copernicus Data Space Ecosystem will be continously upgraded and how more data become available.
    </div>
</details>
...
<details>
  <summary>Will LTA process be discontinued when all archived data become online?</summary>
    <div>
    There will still be services available for so called “deferred data access” :  data collections that are not commonly used. That said, all most relevant collections will be available on-line.  The [Link to ROAD MAP] shows how the Copernicus Data Space Ecosystem will be continously upgraded and how more data become available.
    </div>
</details>
<details>
...
<details>
  <summary>This December advertisement of DAS (https://medium.com/sentinel-hub/new-copernicus-data-access-service-to-support-the-ecosystem-for-earth-observation-412f829355a3) says that "For those interested in processing, there will be scalable cloud resources available, optimized for EO tasks". Does this refer to the current CreoDIAS resources, or something completely new that hasn't been addressed yet?</summary>
    <div>
    Scalable cloud resources will be part of the commercial offering and can be obtained at [Link to CREODIAS] in first instance. ICT-wise, there will be two options, including Open Telekom Cloud.
    </div>
</details>
<details>
