...
def collection_fly(collectionid, text):
    directory = "collections_fly"
    file_name = f"{directory}/{collectionid}.qmd"
    ...
    with open(file_name, "w") as qmd_file:
        qmd_file.write(text)
...
for c in meta:
    ...
    file_test = collection_fly(collectionID,fly_content)
    summary_text = f"""
...
<a href="{file_test}">load file here </a>
