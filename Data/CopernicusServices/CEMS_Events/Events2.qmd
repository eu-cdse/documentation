<!--
Removal reason 17/11/2025 : Search results on the documentation portal still surface this page, but the navigation path to it is no longer available. Leaving the page hidden for now, as the button-based layout might be useful for future reuse.
---
title: "Events"
aliases: 
  - /Data/CEMS_Events/Events2.html
  - /Data/ComplementaryData/CEMS_Events/Events2.html
format:
  html:
    toc: false
