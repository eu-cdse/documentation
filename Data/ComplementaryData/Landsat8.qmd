...
Landsat-8 Collection 2 Level-1 data with full worldwide coverage, mirrored from the United States Geological Survey, for the years 2021 to the present are now available in the Copernicus Data Space Ecosystem Catalogue. These datasets will be systematically indexed in the OData Catalogue. This Landsat collection will be searchable via the Copernicus Browser. A visualization service will be added soon. Downloading the full product is not available to general users.
...
# OpenSearch
[https://catalogue.dataspace.copernicus.eu/resto/api/collections/LANDSAT-8/search.json?](https://catalogue.dataspace.copernicus.eu/resto/api/collections/LANDSAT-8-ESA/search.json?){target="_blank"}
