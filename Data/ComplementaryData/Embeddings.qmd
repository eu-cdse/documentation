---
title: Global Embeddings Dataset 
---
    ...
    <table class="table-quotas">
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: left; vertical-align: middle">hash generated from geometry, time, product_id, and embeddings model</td>
            </tr>
            <tr>
                <td style="text-align: center; vertical-align: middle">embeddings</td>
                <td style="text-align: center; vertical-align: middle">array</td>
                <td style="text-align: left; vertical-align: middle">raw embeddings array</td>
            </tr>
            <tr>
...
* s3://eodata/geoAI-embeddings/MajorTOM/Core-S1RTC-DeCUR
* s3://eodata/geoAI-embeddings/MajorTOM/Core-S1RTC-SSL4EO
* s3://eodata/geoAI-embeddings/MajorTOM/Core-S2L1C-DeCUR
* s3://eodata/geoAI-embeddings/MajorTOM/Core-S2L1C-SSL4EO
* s3://eodata/geoAI-embeddings/MajorTOM/Core-S2L2A-MMEarth
* s3://eodata/geoAI-embeddings/MajorTOM/Core-S2RGB-DINOv2
* s3://eodata/geoAI-embeddings/MajorTOM/Core-S2RGB-SigLIP
