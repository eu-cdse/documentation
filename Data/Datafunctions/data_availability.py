    ...
    try: 
        ...
        for i in range(0, data_offer):
            ...
            try:
                ...
                sp3 = ''
            try:
                sen6 = c['summaries']['DataAvailability'][i]['SEN6']
            except Exception:
                sen6 = ''
            try:
            ...
            t.append([product_id, content, eof, tqz, tar, zip, sp3, sen6, policy, catalogapi, S3path])
            note += footnotes
            headers = ["Product ID", "Content", "EOF", "TGZ", "tar","zip","sp3", "SEN6","Rolling Policy","Catalog API","S3 Path"]
        ...
        for product_id in  product_ids:
            ...
            for i in range(0, int(counts[product_id])):
                ...
                try:
                    ...
                    temporal = ''
                try:
                    ds_frequency = c['summaries']['DataAvailability'][i-1]['DS_frequency']
                except Exception:
                    temporal = ''    
                try:
                    product_link = c['summaries']['DataAvailability'][i-1]['ProductLink']
                ...
                try:
                    ...
                    odata = ''
                try:
                    data_access = c['summaries']['DataAvailability'][i-1]['DataAccess']
                except Exception:
                    data_access = ''    
