<!--
Removal reason: https://dataspace.copernicus.eu/news/2025-10-3-introducing-new-data-availability-page-easier-access-sentiboard
---
...
Access Link : [https://operations.dashboard.copernicus.eu/index](https://operations.dashboard.copernicus.eu/index){target="_blank"}
...
![](_images/Dashboard/Dashboard2.png){fig-align="center"}


![](_images/Dashboard/Dashboard3.png){fig-align="center"}
...
![](_images/Dashboard/Dashboard4.png){fig-align="center"}
...
![](_images/Dashboard/Dashboard5.png){fig-align="center"}

In the coming year the Dashboard is planned to improve the emerging requirements. 

For any inquiries on the Copernicus Operations Dashboard [contact us](mailto:info_obs.dasboard@omcs.atlassian.net).
