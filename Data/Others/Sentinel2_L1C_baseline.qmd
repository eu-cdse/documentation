...
These products can be differentiated by the [OData](https://documentation.dataspace.copernicus.eu/APIs/OData.html#query-by-attributes){target="_blank"} **processingBaseline** attribute. Processing Baseline is presented on Copernicus Browser as a "Processor version" attribute.
