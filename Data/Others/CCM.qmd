...
The information on dataset specifications are available at the page [Copernicus Contributing Missions Collections Description](https://dataspace.copernicus.eu/explore-data/data-collections/copernicus-contributing-missions/ccm-collections-description){target="_blank"}.
...
The Copernicus DEM EEA-10 offers coverage on Europe at a resolution of 10 metres. Access is limited to eligible CCM User Categories and requires an application. For application process please visit [How to access COP-DEM 10m?](https://documentation.dataspace.copernicus.eu/FAQ.html#how-to-access-COP-DEM-10m){target="_blank"} and proceed accordingly.
...
Once access is granted, the Copernicus DEM EEA-10 can be downloaded from [OData](https://documentation.dataspace.copernicus.eu/APIs/OData.html){target="_blank"} or from the [Copernicus Browser](https://browser.dataspace.copernicus.eu/){target="_blank"}. For details please see the [Copernicus DEM subtitle](https://documentation.dataspace.copernicus.eu/Data/Others/CCM.html#copernicus-dem-1) at the bottom of this page.

For more information on Copernicus DEM, please visit the [Copernicus DEM - Global and European Digital Elevation Model](https://dataspace.copernicus.eu/explore-data/data-collections/copernicus-contributing-missions/collections-description/COP-DEM){target="_blank"} page.
...
<br> The Copernicus DEM GLO-90 offers global coverage at a resolution of 90 metres.
...
# COG products of VHR datasets {#cog-products-of-vhr-datasets}
...
1. **Product Names in CDSE catalogue**: a -COG suffix has been added to product names. Example: 
SP07_NAO_MS4_2A_20210729T064948_20210729T064958_TOU_1234_90f0.DIMA -> SP07_NAO_MS4_2A_20210729T064948_20210729T064958_TOU_1234_90f0.DIMA-COG 
2. **Product Names in S3 interface**: for technical constraints and avoid data overwriting, a _COG suffix has been added to product names before the final dot when present. Example: 
KS04_AIS_MSP_1G_20170517T121901_20170517T121903_TOU_1234_4169.DIMA_3b0deec3 -> KS04_AIS_MSP_1G_20170517T121901_20170517T121903_TOU_1234_4169_COG.DIMA_3b0deec3 
3. **Product Types**: A -COG suffix has been appended to product types. Example: 
PHR_BUN__3_71F4 -> PHR_BUN__3_71F4-COG
...
<strong>Note:</strong>Only the L3 products, processed in the European projection, have also been converted to COG format and made available for download.

As a result, on the Copernicus Browser search results page, the <strong>Visualise</strong> button will be enabled only for these products, as in the example below:

![](_images/CCM/cog_of_vhr_search_results_example.png){fig-align="center"}
...
![](_images/CCM/cog_of_vhr_dn_to_radiance.png){fig-align="center"}
...
![](_images/CCM/cog_of_vhr_radiance_to_reflectance.png){fig-align="center"}
...
3. **Apply scale transformations**: Modify the VRT file by adding scale_ratio and scale_offset fields, computed as follows:
  Radiance calculation: L = DN x G1 + B1
  Reflectance calculation: R = L x G2 + B2
  Final scale parameters: 
      ScaleRatio = G1 x G2 
      ScaleOffset = B1 x G2 + B2
