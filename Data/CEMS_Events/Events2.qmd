  ...
  color: blue;
    ...
    <script type="text/javascript">
            ...
            function changeActiveTab(newTab) {
                ...
                const tabId = newTab.toLowerCase().replace(' ', '_').replace(',', '_')
        ...
        <button id='strom' onclick="openTabFromJson('Strom')">Storm</button>
        ...
        <button id='wind_strom' onclick="openTabFromJson('Wind strom')">Wind strom</button>
