    ...
    <table class="table-quotas">
        ...
        <tbody>
            ...
            <tr>
				...
				<br>The default value set to "Status", if not provided by user, is "running".
				<br>A running subscription is automatically set to paused after 60 days of inactivity. After 365 days from the last notification, the subscription status is changed to cancelled and the subscription is permanently deleted.
				</td>
