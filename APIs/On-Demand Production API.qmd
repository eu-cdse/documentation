...
For Sentinel-2-L1-S2MSI2A the input is searched in the catalogue and it is possible that the baseline of the found product is different from the baseline provided in the WorkflowOptions.
