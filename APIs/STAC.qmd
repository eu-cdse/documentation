...
::: {.callout-note title="Legacy STAC Endpoint deprecated"}
...
* CLMS Burnt Area (BA) Global 300m daily V3 (COG)
* CLMS Burnt Area (BA) Global 300m daily V3 (NetCDF)
* CLMS Burnt Area (BA) Global 300m daily V4 (COG)
* CLMS Burnt Area (BA) Global 300m daily V4 (NetCDF)
* CLMS Burnt Area (BA) Global 300m monthly V3 (COG)
* CLMS Burnt Area (BA) Global 300m monthly V3 (NetCDF)
* CLMS Burnt Area (BA) Global 300m monthly V4 (COG)
* CLMS Burnt Area (BA) Global 300m monthly V4 (NetCDF)
* CLMS CLCplus LULUCF Instance Europe 100m yearly V1 (COG)
* CLMS Dry Matter Productivity (DMP) Global 1km 10-daily V2 (COG)
* CLMS Dry Matter Productivity (DMP) Global 1km 10-daily V2 (NetCDF)
* CLMS Dry Matter Productivity (DMP) Global 300m 10-daily V1 (COG)
* CLMS Dry Matter Productivity (DMP) Global 300m 10-daily V1 (NetCDF)
* CLMS Dry Matter Productivity (DMP) Global 300m 10-daily V2 (COG)
* CLMS Dry Matter Productivity (DMP) Global 300m 10-daily V2 (NetCDF)
* CLMS Evapotranspiration (ETA) Global 300m 10-daily V1 (COG)
* CLMS Fraction of Absorbed Photosynthetically Active Radiation (FAPAR) Global 1km 10-daily V2 (COG)
* CLMS Fraction of Absorbed Photosynthetically Active Radiation (FAPAR) Global 1km 10-daily V2 (NetCDF)
* CLMS Fraction of Absorbed Photosynthetically Active Radiation (FAPAR) Global 300m 10-daily V1 (COG)
* CLMS Fraction of Absorbed Photosynthetically Active Radiation (FAPAR) Global 300m 10-daily V1 (NetCDF)
* CLMS Fraction of Absorbed Photosynthetically Active Radiation (FAPAR) Global 300m 10-daily V2 (COG)
* CLMS Fraction of Absorbed Photosynthetically Active Radiation (FAPAR) Global 300m 10-daily V2 (NetCDF)
* CLMS Fraction of Green Vegetation Cover (FCOVER) Global 1km 10-daily V2 (COG)
* CLMS Fraction of Green Vegetation Cover (FCOVER) Global 1km 10-daily V2 (NetCDF)
* CLMS Fraction of Green Vegetation Cover (FCOVER) Global 300m 10-daily V1 (COG)
* CLMS Fraction of Green Vegetation Cover (FCOVER) Global 300m 10-daily V1 (NetCDF)
* CLMS Fraction of Green Vegetation Cover (FCOVER) Global 300m 10-daily V2 (COG)
* CLMS Fraction of Green Vegetation Cover (FCOVER) Global 300m 10-daily V2 (NetCDF)
* CLMS Gross Dry Matter Productivity (GDMP) Global 1km 10-daily V2 (COG)
* CLMS Gross Dry Matter Productivity (GDMP) Global 1km 10-daily V2 (NetCDF)
* CLMS Gross Dry Matter Productivity (GDMP) Global 300m 10-daily V1 (COG)
* CLMS Gross Dry Matter Productivity (GDMP) Global 300m 10-daily V1 (NetCDF)
* CLMS Gross Dry Matter Productivity (GDMP) Global 300m 10-daily V2 (COG)
* CLMS Gross Dry Matter Productivity (GDMP) Global 300m 10-daily V2 (NetCDF)
* CLMS Gross Primary Production (GPP) Global 300m 10-daily V1 (COG)
* CLMS Gross Primary Production (GPP) Global 300m 10-daily V1 (NetCDF)
* CLMS Gross Primary Production (GPP) Global 300m 10-daily V2 (COG)
* CLMS Gross Primary Production (GPP) Global 300m 10-daily V2 (NetCDF)
* CLMS Heat Flux (HF) Global 300m daily V1 (COG)
* CLMS Leaf Area Index (LAI) Global 1km 10-daily V2 (COG)
* CLMS Leaf Area Index (LAI) Global 1km 10-daily V2 (NetCDF)
* CLMS Leaf Area Index (LAI) Global 300m 10-daily V1 (COG)
* CLMS Leaf Area Index (LAI) Global 300m 10-daily V1 (NetCDF)
* CLMS Leaf Area Index (LAI) Global 300m 10-daily V2 (COG)
* CLMS Leaf Area Index (LAI) Global 300m 10-daily V2 (NetCDF)
* CLMS Land Cover (LC) Global 100m yearly V3 (COG)
* CLMS Land Cover Map (LCM) Global 10m yearly V1 (COG)
* CLMS Lake Ice Extent (LIE) Baltic 250m daily V1 (COG)
* CLMS Lake Ice Extent (LIE) Baltic 250m daily V1 (NetCDF)
* CLMS Lake Ice Extent (LIE) Europe 250m daily V2 (COG)
* CLMS Lake Ice Extent (LIE) Europe 250m daily V2 (NetCDF)
* CLMS Lake Ice Extent (LIE) Global 500m daily V2 (COG)
* CLMS Lake Ice Extent (LIE) Global 500m daily V2 (NetCDF)
* CLMS Lake Ice Extent (LIE) Northern Hemisphere 500m daily V1 (COG)
* CLMS Lake Ice Extent (LIE) Northern Hemisphere 500m daily V1 (NetCDF)
* CLMS Land Surface Phenology (LSP) Global 300m yearly V1 (COG)
* CLMS Land Surface Phenology (LSP) Global 300m yearly V2 (COG)
* CLMS Land Surface Temperature (LST) Daily Cycle Global 3km 10-daily V3 (COG)
* CLMS Land Surface Temperature (LST) Daily Cycle Global 3km 10-daily V3 (NetCDF)
* CLMS Land Surface Temperature (LST) Daily Cycle Global 5km 10-daily V1 (COG)
* CLMS Land Surface Temperature (LST) Daily Cycle Global 5km 10-daily V1 (NetCDF)
* CLMS Land Surface Temperature (LST) Daily Cycle Global 5km 10-daily V2 (COG)
* CLMS Land Surface Temperature (LST) Daily Cycle Global 5km 10-daily V2 (NetCDF)
* CLMS Land Surface Temperature with Thermal Condition Index (LST-TCI) Global 3km 10-daily V3 (COG)
* CLMS Land Surface Temperature with Thermal Condition Index (LST-TCI) Global 3km 10-daily V3 (NetCDF)
* CLMS Land Surface Temperature with Thermal Condition Index (LST-TCI) Global 5km 10-daily V1 (COG)
* CLMS Land Surface Temperature with Thermal Condition Index (LST-TCI) Global 5km 10-daily V1 (NetCDF)
* CLMS Land Surface Temperature with Thermal Condition Index (LST-TCI) Global 5km 10-daily V2 (COG)
* CLMS Land Surface Temperature with Thermal Condition Index (LST-TCI) Global 5km 10-daily V2 (NetCDF)
* CLMS Land Surface Temperature (LST) Global 3km hourly V3 (COG)
* CLMS Land Surface Temperature (LST) Global 3km hourly V3 (NetCDF)
* CLMS Land Surface Temperature (LST) Global 5km hourly V1 (COG)
* CLMS Land Surface Temperature (LST) Global 5km hourly V1 (NetCDF)
* CLMS Land Surface Temperature (LST) Global 5km hourly V2 (COG)
* CLMS Land Surface Temperature (LST) Global 5km hourly V2 (NetCDF)
* CLMS Lake Surface Water Temperature (LSWT) NRT Global 1km 10-daily V1 (COG)
* CLMS Lake Surface Water Temperature (LSWT) NRT Global 1km 10-daily V1 (NetCDF)
* CLMS Lake Surface Water Temperature (LSWT) Offline Global 1km 10-daily V1 (COG)
* CLMS Lake Surface Water Temperature (LSWT) Offline Global 1km 10-daily V1 (NetCDF)
* CLMS Lake Water Quality (LWQ) NRT Global 100m 10-daily V1 (COG)
* CLMS Lake Water Quality (LWQ) NRT Global 100m 10-daily V1 (NetCDF)
* CLMS Lake Water Quality (LWQ) NRT Global 100m 10-daily V2 (COG)
* CLMS Lake Water Quality (LWQ) NRT Global 100m 10-daily V2 (NetCDF)
* CLMS Lake Water Quality (LWQ) NRT Global 300m 10-daily V1 (COG)
* CLMS Lake Water Quality (LWQ) NRT Global 300m 10-daily V1 (NetCDF)
* CLMS Lake Water Quality (LWQ) NRT Global 300m 10-daily V2 (COG)
* CLMS Lake Water Quality (LWQ) NRT Global 300m 10-daily V2 (NetCDF)
* CLMS Lake Water Quality (LWQ) Reproc Global 300m 10-daily V1 (COG)
* CLMS Lake Water Quality (LWQ) Reproc Global 300m 10-daily V1 (NetCDF)
* CLMS Normalized Difference Vegetation Index (NDVI) Long-Term Statistics (LTS) Global 1km 10-daily V2 (COG)
* CLMS Normalized Difference Vegetation Index (NDVI) Long-Term Statistics (LTS) Global 1km 10-daily V2 (NetCDF)
* CLMS Normalized Difference Vegetation Index (NDVI) Long-Term Statistics (LTS) Global 1km 10-daily V3 (COG)
* CLMS Normalized Difference Vegetation Index (NDVI) Long-Term Statistics (LTS) Global 1km 10-daily V3 (NetCDF)
* CLMS Normalized Difference Vegetation Index (NDVI) Short-Term Statistics (STS) Global 1km 10-daily V3 (NetCDF)
* CLMS Normalized Difference Vegetation Index (NDVI) Global 1km 10-daily V2 (COG)
* CLMS Normalized Difference Vegetation Index (NDVI) Global 1km 10-daily V2 (NetCDF)
* CLMS Normalized Difference Vegetation Index (NDVI) Global 1km 10-daily V3 (COG)
* CLMS Normalized Difference Vegetation Index (NDVI) Global 1km 10-daily V3 (NetCDF)
* CLMS Normalized Difference Vegetation Index (NDVI) Global 300m 10-daily V1 (COG)
* CLMS Normalized Difference Vegetation Index (NDVI) Global 300m 10-daily V1 (NetCDF)
* CLMS Normalized Difference Vegetation Index (NDVI) Global 300m 10-daily V2 (COG)
* CLMS Normalized Difference Vegetation Index (NDVI) Global 300m 10-daily V2 (NetCDF)
* CLMS Normalized Difference Vegetation Index (NDVI) Global 300m 10-daily v3 (COG)
* CLMS Normalized Difference Vegetation Index (NDVI) Global 300m 10-daily V3 (NetCDF)
* CLMS Net Primary Production (NPP) Global 300m 10-daily V1 (COG)
* CLMS Net Primary Production (NPP) Global 300m 10-daily V1 (NetCDF)
* CLMS Net Primary Production (NPP) Global 300m 10-daily V2 (COG)
* CLMS Net Primary Production (NPP) Global 300m 10-daily V2 (NetCDF)
* CLMS Snow Cover Extent (SCE) Europe 500m daily V1 (COG)
* CLMS Snow Cover Extent (SCE) Europe 500m daily V1 (NetCDF)
* CLMS Snow Cover Extent (SCE) Global 1km daily V1 (COG)
* CLMS Snow Cover Extent (SCE) Global 1km daily V1 (NetCDF)
* CLMS Snow Cover Extent (SCE) Northern Hemisphere 1km daily V1 (COG)
* CLMS Snow Cover Extent (SCE) Northern Hemisphere 1km daily V1 (NetCDF)
* CLMS Surface Soil Moisture (SSM) Europe 1km daily v1 (COG)
* CLMS Surface Soil Moisture (SSM) Europe 1km daily v1 (NetCDF)
* CLMS Snow Water Equivalent (SWE) Northern Hemisphere 5km daily V1 (COG)
* CLMS Snow Water Equivalent (SWE) Northern Hemisphere 5km daily V1 (NetCDF)
* CLMS Snow Water Equivalent (SWE) Northern Hemisphere 5km daily V2 (COG)
* CLMS Snow Water Equivalent (SWE) Northern Hemisphere 5km daily V2 (NetCDF)
* CLMS Soil Water Index (SWI) Static Layers Global 12.5km V3 (COG)
* CLMS Soil Water Index (SWI) Static Layers Global 12.5km V3 (NetCDF)
* CLMS Soil Water Index (SWI) Timeseries Global 12.5km V3 (NetCDF)
* CLMS Soil Water Index (SWI) Europe 1km daily V1 (COG)
* CLMS Soil Water Index (SWI) Europe 1km daily V1 (NetCDF)
* CLMS Soil Water Index (SWI) Europe 1km daily V2 (COG)
* CLMS Soil Water Index (SWI) Europe 1km daily V2 (NetCDF)
* CLMS Soil Water Index (SWI) Global 12.5km 10-daily V3 (COG)
* CLMS Soil Water Index (SWI) Global 12.5km 10-daily V3 (NetCDF)
* CLMS Soil Water Index (SWI) Global 12.5km 10-daily V4 (COG)
* CLMS Soil Water Index (SWI) Global 12.5km 10-daily V4 (NetCDF)
* CLMS Soil Water Index (SWI) Global 12.5km daily V3 (COG)
* CLMS Soil Water Index (SWI) Global 12.5km daily V3 (NetCDF)
* CLMS Soil Water Index (SWI) Global 12.5km daily V4 (COG)
* CLMS Soil Water Index (SWI) Global 12.5km daily V4 (NetCDF)
* CLMS Tree Cover Density (TCD) Pantropical 10m yearly V1 (COG)
* CLMS Top-of-Canopy (TOC) Reflectance Global 300m daily V2 (NetCDF)
...
* CLMS Water Bodies (WB) Global 100m monthly V1 (COG)
* CLMS Water Bodies (WB) Global 100m monthly V1 (NetCDF)
* CLMS Water Bodies (WB) Global 1km 10-daily V2 (COG)
* CLMS Water Bodies (WB) Global 1km 10-daily V2 (NetCDF)
* CLMS Water Bodies (WB) Global 300m 10-daily V1 (COG)
* CLMS Water Bodies (WB) Global 300m 10-daily V1 (NetCDF)
* CLMS Water Bodies (WB) Global 300m monthly V2 (COG)
* CLMS Water Bodies (WB) Global 300m monthly V2 (NetCDF)
* CLMS Water Level (WL) Lakes Global vector daily V2 (GeoJSON)
* CLMS Water Level (WL) Rivers Global vector daily V2 (GeoJSON)
* Cloud Classification 2016-present (raster 20 m), Europe, daily
* Fractional Snow Cover 2016-present (raster 20 m), Europe, daily
* Gap-filled Fractional Snow Cover 2016-present (raster 60 m), Europe, daily
* High Resolution Water Layer 2021 (raster 100 m, LAEA projection), Europe, 3-yearly
* High Resolution Water Layer 2021 (raster 10 m, LAEA projection), Europe, 3-yearly
* High Resolution Water Layer 2021 (raster 10 m), Europe, 3-yearly
* Ice Cover Duration 2016-present (raster 100 m, LAEA projection), Europe, annually
* Ice Cover Duration 2016-present (raster 20 m, LAEA projection), Europe, annually
* Ice Cover Duration 2016-present (raster 20 m), Europe, annually
* SAR Wet Snow 2016-present (raster 60 m), Europe, daily
* Snow Phenology Sentinel-2 & Sentinel-1 2016-present (raster 100 m, LAEA projection), Europe, annually
* Snow Phenology Sentinel-2 & Sentinel-1 2016-present (raster 60 m, LAEA projection), Europe, annually
* Snow Phenology Sentinel-2 & Sentinel-1 2016-present (raster 60 m), Europe, annually
* Snow Phenology Sentinel-2 2016-present (raster 100 m, LAEA projection), Europe, annually
* Snow Phenology Sentinel-2 2016-present (raster 20 m, LAEA projection), Europe, annually
* Snow Phenology Sentinel-2 2016-present (raster 20 m), Europe, annually
* Water Cover Duration 2016-present (raster 100 m, LAEA projection), Europe, annually
* Water Cover Duration 2016-present (raster 10 m, LAEA projection), Europe, annually
* Water Cover Duration 2016-present (raster 10 m), Europe, annually
* Water/Ice Cover S1+S2 2016-present (raster 60 m), Europe, daily
* Water/Ice Cover S1 2016-present (raster 60 m), Europe, daily
* Water/Ice Cover S2 2016-present (raster 20 m), Europe, daily
* Wet/Dry Snow 2016-present (raster 60 m), Europe, daily
...
In order to support the CDSE users with utilization of the new CDSE STAC API, a set of Jupyter Notebooks is available on [GitHub](https://github.com/eu-cdse/notebook-samples/tree/main/geo){target="_blank"}.
