...
The OpenSearch     absced standard aims to provide an easy way to query a repository containing Earth Observation data and to enable repository syndication.
