...
![STAC Browser start screen](APIs/_images/STACBrowserStartScreen.png)
...
![STAC Browser header](APIs/_images/STACBrowserHeader.png)
...
![STAC Browser main page](APIs/_images/STACBrowserMainPage.png)
...
![STAC Browser catalogs](APIs/_images/STACBrowserCatalogs.png)
...
![STAC Browser Sentinel-1 GRD Collection](APIs/_images/STACBrowserS1GRD.png)
...
![STAC Browser Show Filters Bar](APIs/_images/STACBrowserShowFilters.png)
...
![STAC Browser Temporal Extent](APIs/_images/STACBrowserTemporalExtent.png)

[Fig 7: STAC Browser Temporal Extent]

The user can define the desired time range

![STAC Browser Spatial Extent](APIs/_images/STACBrowserSpatialExtent.png)

[Fig 8: STAC Browser Spatial Extent]

The user can use the interactive map to specify the spatial extent.

![STAC Browser Additional Filters Sentinel-1 GRD](APIs/_images/STACBrowserAdditionalFilters.png)
...
![STAC Browser Additional Filters](APIs/_images/STACBrowserAdditionalFiltersS2.png)

[Fig 10: STAC Browser Additional Filters Sentinel-2 Level-2A]

![STAC Browser Items Limit](APIs/_images/STACBrowserItemLimit.png)
...
![STAC Browser Assets in Items](APIs/_images/STACBrowserAssetsInItems.png)
...
![STAC Browser Filters Example](APIs/_images/STACBrowserExample.png)
...
![STAC Browser Filters Result](APIs/_images/STACBrowserResults.png)

[Fig 14: STAC Browser Filters Result]

![STAC Browser Item](APIs/_images/STACBrowserItem.png)
