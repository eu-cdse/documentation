...
::: {.callout-note title="Consolidation of STAC Endpoints"}

Starting from 17 November 2025, the legacy STAC endpoint of the CDSE [`https://catalogue.dataspace.copernicus.eu/stac`](https://catalogue.dataspace.copernicus.eu/stac) will be deprecated. The URL will continue to resolve but will provide the same content as [`https://stac.dataspace.copernicus.eu/v1/`](https://stac.dataspace.copernicus.eu/v1/){target="_blank"}.
