...
listing: 
  - id: StacExtensions
    contents:
        - notebook-samples/stac/stac_ndvi.ipynb
        - notebook-samples/stac/stac_query_alps_2ops.ipynb
        - notebook-samples/stac/stac_filter_prague.ipynb
        - notebook-samples/stac/stac_filter_prague_snowcover.ipynb
        - notebook-samples/stac/stac_query_madeira.ipynb
    type: grid
    filter-ui: true
    fields: [title]
---
