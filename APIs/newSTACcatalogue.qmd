...
Both STAC endpoints now serve the same updated catalogue content.  

The previous endpoint [`https://catalogue.dataspace.copernicus.eu/stac`](https://catalogue.dataspace.copernicus.eu/stac){target="_blank"} is **deprecated**, but it continues to provide the same content as:  

[`https://stac.dataspace.copernicus.eu/v1/`](https://stac.dataspace.copernicus.eu/v1/){target="_blank"}  

Please update your references and integrations accordingly.
