...
Starting from 17 November 2025, both STAC endpoints will serve the same updated catalogue content. 

The previous endpoint [`https://catalogue.dataspace.copernicus.eu/stac`](https://catalogue.dataspace.copernicus.eu/stac){target="_blank"} is being deprecated, but it will continue to provide the same content as: 
