...
![Fig 1: STAC Browser Start Screen](APIs/_images/STACBrowserStartScreen.png)
...
![Fig 2: STAC Browser Header](APIs/_images/STACBrowserHeader.png)
...
![Fig 3: STAC Browser Main Page](APIs/_images/STACBrowserMainPage.png)
...
![Fig 4: STAC Browser Catalogs](APIs/_images/STACBrowserCatalog.png)
...
![Fig 5: STAC Browser Sentinel-1 GRD Collection](APIs/_images/STACBrowserS1GRD.png)
...
![Fig 6: STAC Browser Show Filters Bar](APIs/_images/STACBrowserShowFilters.png)

After clicking the **Show Filters** button, a panel expands, allowing the user to define the desired filters.

![Fig 7: STAC Browser Temporal Extent](APIs/_images/STACBrowserTemporalExtent.png)

The user can define the desired time range

![Fig 8: STAC Browser Spatial Extent](APIs/_images/STACBrowserSpatialExtent.png)

The user can use the interactive map to specify the spatial extent.

![Fig 9: STAC Browser Additional Filters Sentinel-1 GRD](APIs/_images/STACBrowserAdditionalFilters.png)
...
![Fig 10: STAC Browser Additional Filters](APIs/_images/STACBrowserAdditionalFiltersS2.png)

![Fig 11: STAC Browser Items Limit](APIs/_images/STACBrowserItemLimit.png)

In the final step, the user can set the limit of displayed items per page, with a default value of 12.

![Fig 12: STAC Browser Assets in Items](APIs/_images/STACBrowserAssetsInItems.png)
...
![Fig 13: STAC Browser Filters Example](APIs/_images/STACBrowserExample.png)
...
![Fig 14: STAC Browser Filters Result](APIs/_images/STACBrowserResults.png)

![Fig 15: STAC Browser Item](APIs/_images/STACBrowserItem.png)
