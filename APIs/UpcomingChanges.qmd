...
The exact date of the update will be announced [here](UpcomingChanges.qmd) in a separate release note no later than 5 days before the scheduled change.
...
interface will be updated on the **02nd of October 2023**. The update will be announced in a separate release note within [release notes document](ReleaseNotes.qmd). 
