...
Please be informed that the OpenSearch API error handling update was successfully implemented on **24th October 2023**. The details of the change are explained [here](https://documentation.dataspace.copernicus.eu/APIs/ReleaseNotes.html#opensearch-api-error-handling-update-2023-10-24).
...
Please be informed that the OpenSearch API error handling update is planned for **17th of October 2023**. The details of the change are explained [here](https://documentation.dataspace.copernicus.eu/APIs/UpcomingChanges.html#opensearch-api-error-handling-update). 
