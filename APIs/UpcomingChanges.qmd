...
Please be informed that the OpenSearch API error handling update has been rescheduld for **24th of October 2023**. The details of the change are explained [here](https://documentation.dataspace.copernicus.eu/APIs/UpcomingChanges.html#opensearch-api-error-handling-update).
