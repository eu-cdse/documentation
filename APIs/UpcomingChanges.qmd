...
Please be informed that the **STAC API** items interface will be updated on the **5th of October 2023**. The update will be announced in a separate release note within [release notes document](APIs/ReleaseNotes.qmd). 
