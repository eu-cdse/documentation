...
Having the access and secret key together with the endpoint, you can use any tool to handle access via S3. Below is an example of how to access EO Data using the s3cmd.
