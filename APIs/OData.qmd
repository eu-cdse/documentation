...
```
::: {.callout-tip} 
ContentDate/Start is much faster than ContentDate/End for bigger collections. Narrowing ContentDate/Start gives the best performance boost for *SENTINEL-2* collection.
:::
...
::: {.callout-tip} 
Don't use *count* option if not necessary, it slows down the execution time of the request.
:::
