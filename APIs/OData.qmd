...
The list of property names must be separated by a comma - it can also include an extra space. The order of attributes in the response is assigned by default and does not depend on the order of attributesvspecified in the user's query.

In cases where the user does not specify the Id parameter, it will be provided in the response by default.
