...
::: {.callout-tip} 
The examples below assume that the product is saved to a file with the ".zip" extension. The exceptions are Sentinel-5P products, which are released directly with the ".nc" extension.
:::
