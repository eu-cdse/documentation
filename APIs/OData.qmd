...
::: {.callout-tip} 
Crucial for the search performance is specyfying the collection name. Example:
...
```
::: {.callout-tip} 
ContentDate/Start is faster than ContentDate/End. Narrowing ContentDate/Start gives the best performance boost for *SENTINEL-2* collection.
:::
