...
[`https://catalogue.dataspace.copernicus.eu/odata/v1/Products?$filter=Collection/Name eq 'SENTINEL-2'`](https://catalogue.dataspace.copernicus.eu/odata/v1/Products?$filter=Collection/Name%20eq%20%27SENTINEL-2%27){target="_blank"}
...
More examples of OData queries for CLMS can be found [CLMS - examples of OData queries](https://documentation.dataspace.copernicus.eu/Data/CopernicusServices/CLMS.html#examples-of-odata-queries){target="_blank"}
...
[`https://catalogue.dataspace.copernicus.eu/odata/v1/Products?$select=Name,Id`](https://catalogue.dataspace.copernicus.eu/odata/v1/Products?$select=Name,Id){target="_blank"}
...
[`https://catalogue.dataspace.copernicus.eu/odata/v1/Products?$select=*`](https://catalogue.dataspace.copernicus.eu/odata/v1/Products?$select=\*){target="_blank"}
