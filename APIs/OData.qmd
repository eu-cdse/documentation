...
**Currently, users can access Sentinel-1 (RAW, GRD, SLC) data stored in native format and bundled (zipped files) for one month following their publication date within Data Space Catalogue.**
