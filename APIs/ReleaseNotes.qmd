...
## [2023-10-02] OData API single product response update

To be compliant with the OData PRIP interfaces the **OData API** response for a single product query was updated. The response now returns the product itself instead of a list containing the product (assigned to the field `value`). The example reflecting the change is presented below.
