...
Please be informed that [OData Catalogue API Response Format Change
](https://documentation.dataspace.copernicus.eu/APIs/Others/UpcomingChanges.html#odata-catalogue-api-response-format-change) was rescheduled to **24th September 2024**. Therefore, all changes will be implemented starting from **24th September 2024**.
