...
We would like to inform you of the scheduled decommissioning of our OpenSearch Catalogue API interface, **effective 1 February 2026**.
...
Please note that no exceptions or extensions to the decommissioning timeline are planned. After **1 February 2026**, any requests to access OpenSearch Catalogue API will be rejected as the endpoint will not be available for use.
