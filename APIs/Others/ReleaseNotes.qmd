...
Copernicus Data Space Ecosystem STAC Catalog can be accessed using the following URL: [`https://stac.dataspace.copernicus.eu/v1/`](https://stac.dataspace.copernicus.eu/v1/){target="_blank"}.
