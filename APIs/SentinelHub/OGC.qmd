...
API](https://docs.sentinel-hub.com/api/latest/reference/#tag/configuration_instance/operation/createWmsInstance){target="_blank"}
or in the Sentinel Hub
[Dashboard](https://apps.sentinel-hub.com/dashboard/){target="_blank"}
