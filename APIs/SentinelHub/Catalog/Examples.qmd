...
You can search for features on your own BYOC or Zarr collections. The
...
`byoc-<your-collection-id>` for byoc or `zarr-<your-collection-id>` for
zarr). Remember that you will have to use the appropriate deployment
