...
Service accounts.** Please refer to our [FAQ](https://documentation.dataspace.copernicus.eu/FAQ.html#how-can-I-request-to-change-my-copernicus-user-type-from-copernicus-general-user-to-copernicus-services-user) on account
typology change and if you are eligible, then [Submit A
