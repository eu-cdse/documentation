...
**The Batch Processing API is available only for users with Copernicus Service accounts.** Please refer to our [FAQ](https://documentation.dataspace.copernicus.eu/FAQ.html) on account typology change and [Submit A Request](https://helpcenter.dataspace.copernicus.eu/hc/en-gb/requests/new) to our Copernicus Data Space Ecosystem Support Team to request your Copernicus Service account accordingly.
