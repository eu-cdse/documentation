...
Full python code example is available in [jupyter notebook](resources/notebooks/basic_example.ipynb).
...
Additionally, you can build the processing graph using the python client and print the process graph structure using the following command `print(save5.to_json())` as shown in the [jupyter notebook](resources/notebooks/basic_example.ipynb).
