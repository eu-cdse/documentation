---
resources:
- Byoc/resources/python/cdse_set_bucket_access_policy.py
title: Bring Your Own COG API
---

**Bring Your Own COG API is available only for users with Copernicus
...
[here](/APIs/SentinelHub/Byoc/resources/python/cdse_set_bucket_access_policy.py).
