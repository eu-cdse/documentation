...
-   you need to provide the S3 bucket where your data; if you have data
    in CreoDIAS, prefix the bucket name by your CreoDIAS Project ID as
    follows: `PROJECT_ID:bucket_name` ,
