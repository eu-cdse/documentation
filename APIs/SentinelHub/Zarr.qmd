...
accounts.** Please refer to our [FAQ](https://documentation.dataspace.copernicus.eu/FAQ.html#which-entities-are-qualified-to-get-higher-quotas-in-scope-of-copernicus-services-group-and-how-can-one-ask-for-it) on account typology
change and [Submit an account change request](https://dataspace.copernicus.eu/copernicus-services-user){target="_blank"}
