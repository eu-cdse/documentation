...
| Collection | ID |
|:---------:|----|
['|clms_vlcc_fallow-land-presence_europe_10m_yearly_v1|`3dd04866-fe0a-48f2-a07b-033350949919`', '|clms_vlcc_fallow-land-presence-confidence-layer_europe_10m_yearly_v1|`f62789df-4e26-4469-85e5-9f3e464d98f7`']
...
clms_vlcc_fallow-land-presence_europe_10m_yearly_v1| Name          | Description  |   Units |  Source format | Range | Scaling | Offset |
|---------------|--------------|---------|----------------|-------|---------|--------|
|CPFLP|Annual fallow land presence|0 = No fallow land, 1 = Fallow|
UINT16|0.0-1.0|1|0|
clms_vlcc_fallow-land-presence-confidence-layer_europe_10m_yearly_v1| Name          | Description  |   Units |  Source format | Range | Scaling | Offset |
|---------------|--------------|---------|----------------|-------|---------|--------|
