...
|UNC|Uncertainty associated to NDVI|-|INT16|0-1|1/1000|0|
|NOBS|Number of observations used in the BRDF inversion|-|UINT8|0-32|1|0|
|QFLAG|Quality flag|-|UINT8|---|1|0|
|TIMEGRID|Time between the median date of observations used to compute NDVI and the reference time given in the file name.|Minutes|INT16|-8640-15840|1|0|
