...
|NOBS|Number of valid observations during the synthesis period|-|UINT8|0.0-40.0|1|0|
|LENGTH_BEFORE|Length in days of the semi-period before the dekadal date of the compositing window|-|UINT8|15.0-210.0|1|0|
|LENGTH_AFTER|Length in days of the semi-period after the dekadal date of the compositing window|-|UINT8|0.0-60.0|1|0|
