---
title: Leaf Area Index 2014-present (raster 300 m), global, 10-daily – version 2
collection: eed53a75-ea34-4f62-a369-142ff15e2da2
---
## About
...
```default
eed53a75-ea34-4f62-a369-142ff15e2da2
```

RT1:

```default
06a928b8-70cd-4524-9490-a23a3e0af5b8
```

RT2:

```default
03c8cc35-dff3-4446-9989-92d1e24287a7
```

RT6:

```default
4046945c-968d-4411-882e-5842599613e5
```
