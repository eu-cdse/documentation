---
title: GRAC 20m 3-yearly (2021-2024)
collection: 1cd059b0-2bbf-4b74-be45-f88cb81b360d
---
## About
[Official documentation](https://land.copernicus.eu/en/products/high-resolution-layer-grasslands)

The High Resolution Layer Grassland Change (GRAC) 2021-2024 raster product at 20m resolution provides information on changes in grassland vegetation cover between the reference years 2021 and 2024. The thematic classes indicate all non-grassland areas, grassland gain and grassland loss, unchanged grassland in both years and unverified grassland gain and loss areas.
...
[View this dataset in Copernicus Browser](https://browser.dataspace.copernicus.eu/?zoom=10&lat=41.82019&lng=12.57866&themeId=DEFAULT-THEME&datasetId=COPERNICUS_CLMS_VLCC_GRASSLAND-CHANGE_EUROPE_20M_3YEARLY_V1_2021-2024&clmsSelectedPath=Grassland%20Change&clmsSelectedCollection=COPERNICUS_CLMS_VLCC_GRASSLAND-CHANGE_EUROPE_20M_3YEARLY_V1_2021-2024) (Click on 'Show latest date' after the page loads.)
...
```default
1cd059b0-2bbf-4b74-be45-f88cb81b360d
```

Grassland Change Confidence Layer:

```default
9f411567-8ded-4bf3-a67f-b36b3a2a2a8f
```
...
**[Example scripts for this product.](https://github.com/eu-cdse/sentinel-hub-custom-scripts/tree/main/clms/land-cover-and-land-use-mapping/grasslands/grassland-and-herbaceous/grassland-change/clms_vlcc_grassland-change_europe_20m_3yearly_v1_2021-2024)**
