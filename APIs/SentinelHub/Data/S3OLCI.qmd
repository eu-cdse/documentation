...
Units](https://sentiwiki.copernicus.eu/web/olci-products#Processing-Levels){target="_blank"}
...
and unit, however outliers can be expected.
  ...
  VAA                                    Angle (degrees)                                       DEGREES                 INT32           -180 - 180
  VZA                                    Angle (degrees)                                       DEGREES                 UINT32          0 - 180
  SAA                                    Angle (degrees)                                       DEGREES                 INT32           -180 - 180
  SZA                                    Angle (degrees)                                       DEGREES                 UINT32          0 - 180
  ...
  QUALITY_FLAGS                          N/A                                                   DN                      UINT32          0 - 4,294,967,294                    Bit packed value. Use [decodeS3OLCIQualityFlags](/APIs/SentinelHub/Evalscript/Utilities.qmd#decodes3olciqualityflags) to unpack.
...
Sentinel-3 OLCI when mosaicking is `ORBIT`:
  ...
  tiles\[i\].shId               `881338`
  tiles\[i\].dataPath           `'http://eodata.dataspace.copernicus.eu/eodata/Sentinel-3/OLCI/OL_1_EFR/2020/04/04/S3A_OL_1_EFR____20200404T093158_20200404T093458_20200405T131253_0179_056_364_2160_LN1_O_NT_002.SEN3'`
