...
[terms](https://esa.maps.eox.at/copernicus-dem_eula.pdf){target="_blank"}
...
`DEM` `process` API.
  ...
  egm             An option to add geoid heights from an earth gravitational model to the orthometric heights in which case the returned values represent ellipsoidal heights relative to the WGS84 ellipsoid. `<br/>`{=html}`<br/>`{=html} For Copernicus DEMs, we use [EGM2008](https://en.wikipedia.org/wiki/Earth_Gravitational_Model#EGM2008){target="_blank"}.                                                                                                                               **TRUE** - returned values are ellipsoid heights `<br/>`{=html}**FALSE** - returned values are orthometric heights                                                                                                                                                                                                                                                                        **FALSE**
