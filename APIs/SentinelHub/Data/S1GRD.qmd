...
1.  Original or multilooked source chosen (depending on the resolution
    level; multilooking is done in ground range.
...
4.  (Optional) Radiometric terrain correction using [area
    ...
    is performed. [Copernicus DEM](/APIs/SentinelHub/Data/DEM.qmd) is used (see the
...
5.  (Optional) Orthorectification using Range-Doppler terrain correction
    using [Copernicus DEM](/APIs/SentinelHub/Data/DEM.qmd).
...
`S1GRD` `process` API.
  ...
  demInstance                      The DEM used for orthorectification                                                                   \- Copernicus DEM 10m and 30m \[3\]\[4\] `<br/>`{=html} **COPERNICUS_30** - Copernicus DEM 30m \[4\] `<br/>`{=html} **COPERNICUS_90** - Copernicus DEM 90m                                                                                                                                                                                                                                **COPERNICUS_30**
