...
PlanetScope (TPDI) and your own data (BYOC) and with all SH
...
sh.dataspace.copernicus.eu/process/v1 also allows combining
...
Specifying [mosaicking](/APIs/SentinelHub/Evalscript/Functions.qmd#mosaicking)
