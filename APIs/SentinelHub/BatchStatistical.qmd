...
::: {.callout-warning}
## Region Limitation
Currently, the Batch Statistical API only supports object storage in the `WAW3-1` region. Please ensure your bucket is created in this region for compatibility.
:::
