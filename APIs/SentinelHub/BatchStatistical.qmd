...
- BatchStatistical/resources/python/cdse_set_bucket_access_policy.py
title: Batch Statistical API
---

**The Batch Statistical API is available only for users with Copernicus
...
[here](/APIs/SentinelHub/BatchStatistical/resources/python/cdse_set_bucket_access_policy.py).
