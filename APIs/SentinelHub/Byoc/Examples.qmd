...
If you do not yet have a bucket at Copernicus Data Space Ecosystem, please follow [these steps](https://creodias.docs.cloudferro.com/en/latest/new/Access-CREODIAS-environment-to-create-S3-bucket-and-use-it-in-Sentinel-Hub-Batch-Processing-request-on-Creodias.html) to get one.
