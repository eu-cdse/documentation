...
So, while the command is executed is a single command, the --recursive part means that each file downloaded is counted as an individual request in terms of quota count.
