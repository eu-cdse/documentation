...
[`connection.describe_collection()`](https://open-eo.github.io/openeo-python-client/api.html#openeo.rest.connection.Connection.describe_collection){target="_blank"}.
...
First, make sure to complete your
[Copernicus Data Space Ecosystem registration](../../../Registration.md).
Once registered, you will be able to authenticate your `connection` in your Python code
...
Usually, the first time you call this `authenticate_oidc()` method,
an URL will be printed for you to visit, for example something like:

```
Visit https://dataspace.copernicus.eu/device?user_code=EAXD-RQXV to authenticate.
```

Click this URL or copy-paste it to your web browser and log in with
your Copernicus Data Space Ecosystem credentials.
...
Other times, when you still have valid tokens on your system,
