...
For this tutorial we will use the openEO instance of Copernicus Data Space Ecosystem, which is available at `https://openeo-staging.creo.vito.be`.
...
connection = openeo.connect("https://openeo-staging.creo.vito.be")
...
it is not started yet. To start the job and let your Python script wait until the job has finished then 
...
con = openeo.connect("https://openeo-staging.creo.vito.be")
