...
```js
var con = await OpenEO.connect("https://openeo-staging.creo.vito.be");
...
Promises:
```js
OpenEO.connect("https://openeo-staging.creo.vito.be").then(function(con) {
  // Success
...
After successfully authentication, you are logged into the back-end with your account. 
