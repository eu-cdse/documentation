...
A collection of geometries of the same type can be grouped together, forming what is known as a "multi-point" or "multi-polygon." It's important to understand that a multipolygon is essentially just a gathering of several polygons.
