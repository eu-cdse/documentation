...
These limits are in place to avoid that individual users can overload the service. Please contact support via [Submit a request](https://helpcenter.dataspace.copernicus.eu/hc/en-gb/requests/new){target='_blank'} if they are problematic for your use case.
