...
In openEO, a back-end offers a set of collections to be processed. A user can load (a subset of) a collection using a special process, which returns a (spatial) datacube. 
