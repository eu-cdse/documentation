...
In openEO, a back-end offers set of collections to be processed. A user can access and process from this comprehensive [list of data collections](./Collections.qmd) available in the Copernicus Data Space Ecosystem backend through openEO. They can load (a subset of) a collection using a special process, which returns a (spatial) datacube. 
