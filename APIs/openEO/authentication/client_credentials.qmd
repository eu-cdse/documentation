...
When you request a service account through the help center,
other services (like an openEO backend) are not in the loop
and don't automatically get insights into how service accounts are linked
