...
This chapter outlines a complete example of an earth observation use case using the R client. The focus is on synchronous image computation instead of batch job processing. This approach returns results directly in the response, which is ideal for smaller datasets.
