...
listing: 
  - id: LandMonitoring
    contents:
        ...
        - APIs/openEO/openeo-community-examples/python/DynamicLandCoverMapping/Dynamic land cover mapping.ipynb
  ...
  - id: Others
    contents: 
        ...
        - APIs/openEO/openeo-community-examples/python/AccessPROBA-V/PROBA_V.ipynb
        - APIs/openEO/openeo-community-examples/python/Federation/FederatedProcessing.ipynb
        - APIs/openEO/openeo-community-examples/python/ManagingMultipleLargeScaleJobs/ManagingMultipleLargeScaleJobs.ipynb
    type: grid
    filter-ui: true
    fields: [image, title]
